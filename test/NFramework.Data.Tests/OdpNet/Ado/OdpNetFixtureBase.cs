...
namespace NSoft.NFramework.Data.OdpNet.Ado {
    public abstract class OdpNetFixtureBase : IoCSetupBase {
        #region << logger >>
        ...
        public static IOdpNetRepository DefaultOracleRepository {
            get { return IoC.Resolve<IOdpNetRepository>("OdpNetRepository.Default"); }
        }

        public static IOdpNetRepository RealWebRepository {
            get { return IoC.Resolve<IOdpNetRepository>("OdpNetRepository.NSoft"); }
        }
