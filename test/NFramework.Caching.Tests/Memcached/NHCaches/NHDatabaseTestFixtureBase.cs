...
namespace NSoft.NFramework.Caching.Memcached.NHCaches {
    ...
    public abstract class NHDatabaseTestFixtureBase : FluentDatabaseTestFixtureBase {
        ...
        public const string MemcachedCacheProvider =
            @"NSoft.NFramework.Caching.Memcached.NHCaches.MemcachedCacheProvider, NSoft.NFramework.Caching.Memcached";
        ...
        protected virtual void OnTestFixtureSetUp() {
            InitializeNHibernateAndIoC(ContainerFilePath,
                                       ...
                                       new OracleNamingConvention { PropertyWithClassNames = new[] { "Code", "Name" } });
        ...
        protected virtual string ContainerFilePath {
            get {
                return Path.GetFullPath(Path.Combine(AppDomain.CurrentDomain.BaseDirectory,
                                                     "NSoft.NFramework.Caching.IoC.config"));
            }
        }
        ...
        protected virtual IDictionary<string, string> GetNHibernateProperties() {
            ...
            properties.Add(NHibernate.Cfg.Environment.CacheProvider, MemcachedCacheProvider);
        ...
        protected virtual string GetDatabaseName() {
            return @"NSoft_NFramework_Memcached";
        }
