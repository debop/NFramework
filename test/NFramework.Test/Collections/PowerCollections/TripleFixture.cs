...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public class TripleTests {
        ...
        /// </summary>
        private class OddEvenComparable : System.IComparable {
        ...
        /// Comparable that compares ints, sorting odds before evens.
        /// </summary>
        private class GOddEvenComparable : System.IComparable<GOddEvenComparable> {
            public int val;
        ...
        public void Creation() {
            ...
            Triple<Triple<string, int, char>, object, Pair<double, float>> p4 =
                new Triple<Triple<string, int, char>, object, Pair<double, float>>(new Triple<string, int, char>("foo", 12, 'X'), o,
                                                                                   new Pair<double, float>(3.45, -1.2F));
        ...
        public void Stringize() {
            var p1 = new Triple<int, string, StringBuilder>(42, new string('z', 3), new StringBuilder("foo"));
            var p2 = new Triple<int, string, StringBuilder>(0, "hello", null);
            var p3 = new Triple<int, string, StringBuilder>(-122, null, new StringBuilder());
            var p4 = new Triple<string, int, StringBuilder>(null, 11, new StringBuilder("Eric"));
        ...
        public void UncomparableFirst() {
            ...
            Assert.Throws<NotSupportedException>(() => triple1.CompareTo(triple2));
        }

        [Test]
        public void UncomparableSecond() {
            var triple1 = new Triple<int, Unorderable, string>(3, new Unorderable(), "Eric");
            var triple2 = new Triple<int, Unorderable, string>(3, new Unorderable(), "Clapton");
        ...
        public void UncomparableThird() {
            var triple1 = new Triple<int, string, Unorderable>(3, "Oasis", new Unorderable());
            var triple2 = new Triple<int, string, Unorderable>(3, "Oasis", new Unorderable());
        ...
        public void DictionaryKey() {
            var dict1 = new OrderedDictionary<Triple<string, int, double>, string>();
        ...
        public void IComparable() {
            var triple1 = new Triple<int, GOddEvenComparable, string>(4, new GOddEvenComparable(7), "B");
            var triple2 = new Triple<int, GOddEvenComparable, string>(7, new GOddEvenComparable(3), "A");
            IComparable comp = triple1;
            object o = triple2;
            ...
            Assert.Throws<ArgumentException>(() => comp.CompareTo("foo"));
        }

#if !SILVERLIGHT
        [Test]
        public void Serialize() {
            var p1 = new Triple<int, string, string>(-12, "hello", "world");
            var p2 = new Triple<string, string, double>("hi", "elvis", 11);
            var s1 = (Triple<int, string, string>)InterfaceTests.SerializeRoundTrip(p1);
            var s2 = (Triple<string, string, double>)InterfaceTests.SerializeRoundTrip(p2);
