    ...
    public class OrderedBagTests {
        ...
        public void Add() {
            ...
            InterfaceTests.TestReadWriteCollectionGeneric(bag1,
                                                          new string[]
                                                          { null, null, "", "Eric", "foo", "foo", "Hello", "HELLO", "hello" }, true,
                                                          null);
        }
        ...
        public void AsList() {
            ...
            InterfaceTests.TestReadOnlyListGeneric(bag1.AsList(),
                                                   new string[] { null, null, "", "Eric", "foo", "foo", "Hello", "HELLO", "hello" },
                                                   null, StringComparer.InvariantCultureIgnoreCase.Equals);
        ...
        public void Clone() {
            ...
            bag2 = bag1.Clone();
            bag3 = bag1.Clone(); //(OrderedBag<int>)((ICloneable)bag1).Clone();
        ...
        public void CloneContents() {
            ...
            OrderedBag<UtilFixture.CloneableStruct> bag5 = new OrderedBag<UtilFixture.CloneableStruct>(comparison);
            bag5.Add(new UtilFixture.CloneableStruct(143));
            bag5.Add(new UtilFixture.CloneableStruct(1));
            bag5.Add(new UtilFixture.CloneableStruct(23));
            bag5.Add(new UtilFixture.CloneableStruct(1));
            bag5.Add(new UtilFixture.CloneableStruct(8));
            OrderedBag<UtilFixture.CloneableStruct> bag6 = bag5.CloneContents();

            Assert.AreEqual(bag5.Count, bag6.Count);

            // Check that the bags are equal, but not identical (e.g., have been cloned via ICloneable).
            IEnumerator<UtilFixture.CloneableStruct> e1 = bag5.GetEnumerator();
            IEnumerator<UtilFixture.CloneableStruct> e2 = bag6.GetEnumerator();
        ...
        public void SerializeStrings() {
            ...
            InterfaceTests.TestReadWriteCollectionGeneric<string>((ICollection<string>)result,
                                                                  new string[]
                                                                  {
                                                                      null, null, "1", "10", "11", "12", "2", "3", "4", "5", "6", "7", "8"
                                                                      , "9", "cool", "eLVIs", "elvis", "foo", "hello", "Hello", "WORLD"
                                                                  },
                                                                  true);
        }
#endif
