...
#pragma warning restore 659
        ...
        public void IndexOf2() {
            ReadWriteArrayList<MyDouble> list =
                new ReadWriteArrayList<MyDouble>(new MyDouble[]
                                                 {
        ...
        public void IndexOf2ReadOnly() {
            ReadOnlyArrayList<MyDouble> list =
                new ReadOnlyArrayList<MyDouble>(new MyDouble[]
                                                {
                                                    new MyDouble(4), new MyDouble(8), new MyDouble(1), new MyDouble(1), new MyDouble(4),
                                                    new MyDouble(9)
                                                });
