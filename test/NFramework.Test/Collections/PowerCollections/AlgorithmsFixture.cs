...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public class AlgorithmsTests {
        ...
        [Test]
        public void Exists() {
            var coll1 = EnumerableFromArray(new[] { 4.5, 1.2, 7.6, -7.6, -0.04, 1.78, 10.11, 187.4 });
            var coll2 = EnumerableFromArray(new double[] { });

            Assert.IsTrue(Algorithms.Exists(coll1, d => d > 100));
            Assert.IsTrue(Algorithms.Exists(coll1, d => Math.Abs(d) == 0.04));
            Assert.IsFalse(Algorithms.Exists(coll1, d => d < -10.0));
            Assert.IsFalse(Algorithms.Exists(coll2, d => Math.Abs(d) == 0.04));
        }
        ...
        public void TrueForAll() {
            ...
            Assert.IsFalse(Algorithms.TrueForAll(coll1, d => d > 100));
            Assert.IsFalse(Algorithms.TrueForAll(coll1, d => Math.Abs(d) < 10));
            Assert.IsTrue(Algorithms.TrueForAll(coll1, d => d > -10));
            Assert.IsTrue(Algorithms.TrueForAll(coll1, d => Math.Abs(d) < 200));
            Assert.IsTrue(Algorithms.TrueForAll(coll2, d => Math.Abs(d) == 0.04));
        }
        ...
        public void CountWhere() {
            ...
            Assert.AreEqual(0, Algorithms.CountWhere(coll1, d => d > 200));
            Assert.AreEqual(6, Algorithms.CountWhere(coll1, d => Math.Abs(d) < 10));
            Assert.AreEqual(8, Algorithms.CountWhere(coll1, d => d > -10));
            Assert.AreEqual(4, Algorithms.CountWhere(coll1, d => Math.Abs(d) > 5));
            Assert.AreEqual(0, Algorithms.CountWhere(coll2, d => Math.Abs(d) < 10));
        }
        ...
        public void Count() {
            var coll1 = EnumerableFromArray(new[] { 4.5, 1.2, 7.6, -7.6, -0.04, 1.78, 10.11, 187.4 });
            var coll2 = EnumerableFromArray(new double[] { });
            var coll3 = new List<double>(new[] { 4.5, 1.2, 7.6, -7.6, -0.04, 1.78, 10.11, 187.4 });
            var coll4 = new List<double>(new double[] { });
        ...
        public void RemoveWhenTrueCollection() {
            var d_list = new List<double>(new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
            var removed = Algorithms.RemoveWhere(d_list, d => Math.Abs(d) > 5);
            InterfaceTests.TestReadWriteCollectionGeneric(d_list, new[] { 4.5, 1.2, -0.04, 1.78 }, true);
            InterfaceTests.TestReadWriteCollectionGeneric(removed, new[] { 7.6, -7.6, 10.11, 187.4 }, true);

            d_list = new List<double>(new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
            removed = Algorithms.RemoveWhere(d_list, d => d == 0);
            InterfaceTests.TestReadWriteCollectionGeneric(d_list, new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 }, true);
            InterfaceTests.TestReadWriteCollectionGeneric(removed, new double[] { }, true);

            d_list = new List<double>(new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
            removed = Algorithms.RemoveWhere(d_list, d => d < 200);
            InterfaceTests.TestReadWriteCollectionGeneric(removed, new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 }, true);
            Assert.AreEqual(0, d_list.Count);
        }

        [Test]
        public void RemoveWhenTrueList() {
            IList<double> d_list = new List<double>(new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });

            ICollection<double> removed = Algorithms.RemoveWhere(d_list, d => Math.Abs(d) > 5);
            InterfaceTests.TestListGeneric(d_list, new[] { 4.5, 1.2, -0.04, 1.78 });
            InterfaceTests.TestReadWriteCollectionGeneric(removed, new[] { 7.6, -7.6, 10.11, 187.4 }, true);

            d_list = new List<double>(new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
            removed = Algorithms.RemoveWhere(d_list, d => d == 0);
            InterfaceTests.TestListGeneric(d_list, new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
            InterfaceTests.TestReadWriteCollectionGeneric(removed, new double[] { }, true);
            ...
            d_list = new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 };
            removed = Algorithms.RemoveWhere(d_list, d => Math.Abs(d) > 5);
            InterfaceTests.TestEnumerableElements(d_list, new[] { 4.5, 1.2, -0.04, 1.78, 0, 0, 0, 0 });
            InterfaceTests.TestReadWriteCollectionGeneric(removed, new[] { 7.6, -7.6, 10.11, 187.4 }, true);
        }

        [Test]
        public void FindAll() {
            var coll1 = EnumerableFromArray(new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
            double[] expected = { 7.6, -7.6, 10.11, 187.4 };

            var i = 0;
            foreach(var x in Algorithms.FindWhere(coll1, d => Math.Abs(d) > 5)) {
        ...
        public void Convert() {
            var coll1 = EnumerableFromArray(new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
            var result1 = Algorithms.Convert(coll1, x => (int)Math.Round(x));
            InterfaceTests.TestEnumerableElements(result1, new[] { 4, 1, 8, 0, -8, 2, 10, 187 });

            var coll2 = EnumerableFromArray(new double[0]);
            var result2 = Algorithms.Convert(coll2, x => (int)Math.Round(x));
            InterfaceTests.TestEnumerableElements(result2, new int[0]);

            var coll3 = EnumerableFromArray(new[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
            var result3 = Algorithms.Convert<double, double>(coll3, x => Math.Abs(x));
            InterfaceTests.TestEnumerableElements(result3, new[] { 4.5, 1.2, 7.6, 0.04, 7.6, 1.78, 10.11, 187.4 });
        }

        [Test]
        public void ForEach() {
            var coll1 = EnumerableFromArray(new[] { "foo", "bar", "hello", "sailor" });
            var s = string.Empty;
            Algorithms.ForEach(coll1, x => s += "!" + x);
            Assert.AreEqual(s, "!foo!bar!hello!sailor");

            var coll2 = EnumerableFromArray(new string[0]);
            s = string.Empty;
            Algorithms.ForEach(coll2, x => s += "!" + x);
            Assert.AreEqual(s, string.Empty);
        }

        [Test]
        public void Partition() {
            Func<double, bool> isNegative = x => x < 0;

            var list = new List<double>();
            var index = Algorithms.Partition(list, isNegative);
            Assert.AreEqual(0, index);
            Assert.AreEqual(0, list.Count);

            list = new List<double>(new[] { -3.1 });
            ...
            list = new List<double>(new[] { -2, 3.1 });
            index = Algorithms.Partition(list, isNegative);
            Assert.AreEqual(1, index);
            ...
            InterfaceTests.TestEnumerableElementsAnyOrder(list, new[] { -2, -3.1 });
            ...
            var array = new double[] { 2, 6, -8, -7, 3, -1, -2, 4, 2 };
            ...
            InterfaceTests.TestEnumerableElementsAnyOrder(Algorithms.Range(array, index, list.Count - index),
                                                          new double[] { 2, 6, 3, 4, 2 });
        }
        ...
        public void StablePartition() {
            ...
            var list = new List<double>();
            var index = Algorithms.StablePartition(list, isNegative);
            Assert.AreEqual(0, index);
            Assert.AreEqual(0, list.Count);
        ...
        public void CountEqual() {
            var coll1 = EnumerableFromArray(new string[] { "foo", "bar", "eric", "Eric", "BAR", "ERIC", "eric" });
            var coll2 = EnumerableFromArray(new int[0]);
        ...
        public void Concatenate() {
            ...
            Assert.IsTrue(Algorithms.EqualCollections<string>(Algorithms.Concatenate<string>(coll1, new string[0], coll2, coll3, coll1),
                                                              new string[]
                                                              {
                                                                  "hello", "there", "sailor", "eric", "clapton", "abc", "ghi", "xyz",
                                                                  "hello", "there", "sailor"
                                                              }));
        ...
        public void Replace1() {
            ...
            IEnumerable<string> enum2 =
                EnumerableFromArray(new string[] { "foo", "bar", "FOO", "hello", "hello", "sailor", "foo", "bar" });
            ...
            InterfaceTests.TestEnumerableElements(result1,
                                                  new string[] { "baz", "bar", "FOO", "hello", "hello", "sailor", "baz", "bar" });

            result1 = Algorithms.Replace(enum2, "foo", "bar");
            InterfaceTests.TestEnumerableElements(result1,
                                                  new string[] { "bar", "bar", "FOO", "hello", "hello", "sailor", "bar", "bar" });

            result1 = Algorithms.Replace(enum2, "X", "bar");
            InterfaceTests.TestEnumerableElements(result1,
                                                  new string[] { "foo", "bar", "FOO", "hello", "hello", "sailor", "foo", "bar" });
        ...
        public void Replace2() {
            IEnumerable<string> enum1 = EnumerableFromArray(new string[0]);
            IEnumerable<string> enum2 =
                EnumerableFromArray(new string[] { "foo", "bar", "FOO", "hello", "hello", "sailor", "foo", "bar", "hi" });
            ...
            InterfaceTests.TestEnumerableElements(result1,
                                                  new string[] { "foo", "bar", "FOO", "baz", "baz", "sailor", "foo", "bar", "baz" });
            ...
            InterfaceTests.TestEnumerableElements(result1,
                                                  new string[] { null, null, null, "hello", "hello", "sailor", null, null, "hi" });

            result1 = Algorithms.Replace(enum2, delegate(string x) {
                                                    x = "zip";
                                                    return false;
                                                }, null);
            InterfaceTests.TestEnumerableElements(result1,
                                                  new string[] { "foo", "bar", "FOO", "hello", "hello", "sailor", "foo", "bar", "hi" });
        }
        ...
        public void ReplaceInPlace2() {
            ...
            list2 = new List<string>(new string[] { "foo", "bar", "FOO", "hello", "hello", "sailor", "foo", "bar", "hi" });
            Algorithms.ReplaceInPlace(list2, delegate(string x) {
                                                 x = "zip";
                                                 return false;
                                             }, null);
        ...
        public void EqualCollections2() {
            Func<int, int, bool> pred = delegate(int x, int y) { return x <= y; };
		...
		*/
        ...
        public void RemoveDuplicates() {
            IEnumerable<string> coll1 =
                EnumerableFromArray(new string[]
                                    {
                                        "foo", "foo", "foo", "big", "foo", "super", "super", null, null, null, "hello", "there", "sailor",
                                        "sailor"
                                    });
            InterfaceTests.TestEnumerableElements(Algorithms.RemoveDuplicates(coll1),
                                                  new string[] { "foo", "big", "foo", "super", null, "hello", "there", "sailor" });
            ...
            IEnumerable<string> coll11 =
                EnumerableFromArray(new string[]
                                    {
                                        "foo", "Foo", "FOO", "big", "foo", "SUPER", "super", null, null, null, "hello", "there", "sailor",
                                        "sailor"
                                    });
            InterfaceTests.TestEnumerableElements(Algorithms.RemoveDuplicates(coll11, StringComparer.InvariantCultureIgnoreCase),
                                                  new string[] { "foo", "big", "foo", "SUPER", null, "hello", "there", "sailor" });

            IEnumerable<string> coll12 = EnumerableFromArray(new string[] { });
            InterfaceTests.TestEnumerableElements(Algorithms.RemoveDuplicates(coll12, StringComparer.InvariantCultureIgnoreCase),
                                                  new string[] { });

            IEnumerable<string> coll13 = EnumerableFromArray(new string[] { "foo" });
            InterfaceTests.TestEnumerableElements(Algorithms.RemoveDuplicates(coll13, StringComparer.InvariantCultureIgnoreCase),
                                                  new string[] { "foo" });

            IEnumerable<string> coll14 = EnumerableFromArray(new string[] { "Foo", "foo" });
            InterfaceTests.TestEnumerableElements(Algorithms.RemoveDuplicates(coll14, StringComparer.InvariantCultureIgnoreCase),
                                                  new string[] { "Foo" });

            IEnumerable<string> coll15 = EnumerableFromArray(new string[] { "foo", "bAr", "bar" });
            InterfaceTests.TestEnumerableElements(Algorithms.RemoveDuplicates(coll15, StringComparer.InvariantCultureIgnoreCase),
                                                  new string[] { "foo", "bAr" });

            IEnumerable<string> coll16 = EnumerableFromArray(new string[] { "foo", "fOo", "bar" });
            InterfaceTests.TestEnumerableElements(Algorithms.RemoveDuplicates(coll16, StringComparer.InvariantCultureIgnoreCase),
                                                  new string[] { "foo", "bar" });

            Func<string, string, bool> pred = (x, y) => x[0] == y[0];

            IEnumerable<string> coll17 =
                EnumerableFromArray(new string[] { "fiddle", "faddle", "bar", "bing", "deli", "zippy", "zack", "zorch" });
            InterfaceTests.TestEnumerableElements(Algorithms.RemoveDuplicates(coll17, pred),
                                                  new string[] { "fiddle", "bar", "deli", "zippy" });
        }
        ...
        public void RemoveDuplicatesInPlace() {
            ...
            IList<string> list21 =
                Algorithms.ReadWriteList<string>(new string[]
                                                 {
                                                     "foo", "foo", "foo", "big", "foo", "super", "super", null, null, null, "hello",
                                                     "there", "sailor", "sailor"
                                                 });
            Algorithms.RemoveDuplicatesInPlace(list21);
            InterfaceTests.TestEnumerableElements(list21,
                                                  new string[]
                                                  {
                                                      "foo", "big", "foo", "super", null, "hello", "there", "sailor", null, null, null,
                                                      null, null, null
                                                  });
            ...
            InterfaceTests.TestEnumerableElements(array1,
                                                  new string[]
                                                  {
                                                      "foo", "big", "foo", "super", null, "hello", "there", "sailor", null, null, null,
                                                      null, null, null
            ...
            array1 = new string[]
                     { "foo", "Foo", "FOO", "big", "foo", "SUPER", "super", null, null, null, "hello", "there", "sailor", "sailor" };
            ...
            //Func<string,string,bool> pred = delegate(string x, string y)
            //{
            //    return x[0] == y[0];
            //};
        ...
        public void FirstConsecutiveEqual() {
            ...
            IList<string> list3 =
                new List<string>(new string[] { "bar", "hello", "hello", "sailor", "bar", "bar", "bar", "bar", "foo", "foo", "foo" });
        ...
        public void FirstConsecutiveWhere() {
            ...
            Func<int, bool> isOdd = x => (x & 1) == 1; //delegate(int x) { return (x & 1) == 1; };
            Func<int, bool> isEven = x => (x & 1) == 0; // delegate(int x) { return (x & 1) == 0; };
        ...
        public void Copy1() {
            ...
            InterfaceTests.TestListGeneric(list1,
                                           new string[] { "foo", "bar", "baz", "hello", "a1", "a2", "a3", "a4", "b1", "b2", "b3", "b4" });

            Algorithms.Copy(enum1, list1, 0);
            InterfaceTests.TestListGeneric(list1,
                                           new string[]
                                           { "hello", "Sailor", "baz", "hello", "a1", "a2", "a3", "a4", "b1", "b2", "b3", "b4" });
        ...
        public void Reverse1() {
            ...
            InterfaceTests.TestEnumerableElements(Algorithms.Reverse(list2),
                                                  new string[] { "glove", "the", "smell", "baz", "bar", "foo" });
        ...
        public void Rotate1() {
            ...
            IList<string> list2 = new BigList<string>(new string[] { "foo", "bar", "baz", "smell", "the", "glove" });
            InterfaceTests.TestEnumerableElements(Algorithms.Rotate(list2, 1),
                                                  new string[] { "bar", "baz", "smell", "the", "glove", "foo" });
            InterfaceTests.TestListGeneric<string>(list2, new string[] { "foo", "bar", "baz", "smell", "the", "glove" });
            InterfaceTests.TestEnumerableElements(Algorithms.Rotate(list2, 0),
                                                  new string[] { "foo", "bar", "baz", "smell", "the", "glove" });
            InterfaceTests.TestListGeneric<string>(list2, new string[] { "foo", "bar", "baz", "smell", "the", "glove" });
            InterfaceTests.TestEnumerableElements(Algorithms.Rotate(list2, 10),
                                                  new string[] { "the", "glove", "foo", "bar", "baz", "smell" });
            InterfaceTests.TestListGeneric<string>(list2, new string[] { "foo", "bar", "baz", "smell", "the", "glove" });
            InterfaceTests.TestEnumerableElements(Algorithms.Rotate(list2, -2),
                                                  new string[] { "the", "glove", "foo", "bar", "baz", "smell" });
            InterfaceTests.TestListGeneric<string>(list2, new string[] { "foo", "bar", "baz", "smell", "the", "glove" });
            InterfaceTests.TestEnumerableElements(Algorithms.Rotate(list2, -13),
                                                  new string[] { "glove", "foo", "bar", "baz", "smell", "the" });
            InterfaceTests.TestListGeneric<string>(list2, new string[] { "foo", "bar", "baz", "smell", "the", "glove" });
            InterfaceTests.TestEnumerableElements(Algorithms.Rotate(list2, 6),
                                                  new string[] { "foo", "bar", "baz", "smell", "the", "glove" });
            InterfaceTests.TestListGeneric<string>(list2, new string[] { "foo", "bar", "baz", "smell", "the", "glove" });
        ...
        public void SetIntersection() {
            ...
            IEnumerable<string> set1 =
                EnumerableFromArray<string>(new string[] { "apple", "banana", "BAGEL", "APPLE", "cheese", null, "meat", "bAGEL" });
            ...
            InterfaceTests.TestEnumerableElementsAnyOrder(res, new string[] { "cheese", null, "bagel", "bagel" },
        ...
        public void SetUnion() {
            ...
            InterfaceTests.TestEnumerableElementsAnyOrder(result,
                                                          new int[]
                                                          {
            ...
            InterfaceTests.TestEnumerableElementsAnyOrder(res,
                                                          new string[]
                                                          {
                                                              "apple", "apple", "banana", "cheese", null, null, "bagel", "bagel", "meat",
                                                              "pancakes"
                                                          }, StringComparer.InvariantCultureIgnoreCase.Equals);
        }
        ...
        public void SetDifference() {
            ...
            InterfaceTests.TestEnumerableElementsAnyOrder(res, new string[] { "APPLE", "APPLE", "BANANA", "MEAT" },
                                                          StringComparer.InvariantCultureIgnoreCase.Equals);
            res = Algorithms.SetDifference(set2, set1, StringComparer.InvariantCultureIgnoreCase);
            InterfaceTests.TestEnumerableElementsAnyOrder(res, new string[] { null, "PANCAKES" },
                                                          StringComparer.InvariantCultureIgnoreCase.Equals);
        }
        ...
        public void SetSymmetricDifference() {
            ...
            InterfaceTests.TestEnumerableElementsAnyOrder(res, new string[] { "APPLE", "APPLE", null, "MEAT", "PANCAKES", "BANANA" },
                                                          StringComparer.InvariantCultureIgnoreCase.Equals);
        }
        ...
        public void GetSetEqualityComparer() {
            ...
            IEqualityComparer<IEnumerable<string>> comparer2 =
                Algorithms.GetSetEqualityComparer<string>(StringComparer.InvariantCultureIgnoreCase);
            IEnumerable<string> set10 =
                EnumerableFromArray<string>(new string[] { "apple", "banana", "BAGEL", "APPLE", "cheese", null, "meat", "bAGEL" });
            IEnumerable<string> set11 = EnumerableFromArray<string>(new string[] { "CHEESE", "bAgEL", "BAGEL", null, "pancakes", null });
            IEnumerable<string> set12 = EnumerableFromArray<string>(new string[] { null, "PANCAKES", "bagel", "bagel", "cheese", null });
        ...
        public void CartesianProduct() {
            ...
            Pair<int, string>[] expected = {
                                               new Pair<int, string>(1, "foo"), new Pair<int, string>(1, "bar"),
                                               new Pair<int, string>(8, "foo"),
                                               new Pair<int, string>(8, "bar"), new Pair<int, string>(4, "foo"),
        ...
        public void ReadOnlyCollection() {
            ...
            InterfaceTests.TestReadonlyCollectionGeneric<string>(result1, new string[] { "bar", "foo", "hello", "sailor" }, true,
        ...
        public void ReadOnlyDictionary() {
            ...
            InterfaceTests.TestReadOnlyDictionaryGeneric<string, int>(result1, new string[] { "foo", "zap", "HELLO" },
                                                                      new int[] { 12, 123, -1 },
            ...
            InterfaceTests.TestReadOnlyDictionaryGeneric<string, string>(result2, new string[] { null, "foo", "zap" },
                                                                         new string[] { "there", "hi", null },
        ...
        public void AddTypingCollection() {
            ...
            InterfaceTests.TestReadonlyCollectionGeneric<string>(result1, new string[] { "foo", "bar", "hello", "sailor" }, true,
        ...
        public void RemoveTypingCollection() {
            ICollection<string> coll1 =
                new ICollectionWrapper<string>(new OrderedSet<string>(new string[] { "foo", "bar", "hello", "sailor" }));
        ...
        public void ArrayRangeExceptions() {
            ...
            try {
                Algorithms.Range(list, 0, int.MaxValue);
                Assert.Fail("should throw");
            }
            catch(Exception e) {
                Assert.IsTrue(e is ArgumentOutOfRangeException);
            ...
            try {
                Algorithms.Range(list, 1, int.MinValue);
                Assert.Fail("should throw");
            }
            catch(Exception e) {
                Assert.IsTrue(e is ArgumentOutOfRangeException);
            ...
            try {
                Algorithms.Range(list, 45, int.MinValue);
                Assert.Fail("should throw");
            }
            catch(Exception e) {
                Assert.IsTrue(e is ArgumentOutOfRangeException);
            ...
            try {
                Algorithms.Range(list, int.MinValue, 1);
                Assert.Fail("should throw");
            }
            catch(Exception e) {
                Assert.IsTrue(e is ArgumentOutOfRangeException);
            ...
            try {
                Algorithms.Range(list, int.MaxValue, 1);
                Assert.Fail("should throw");
            }
            catch(Exception e) {
                Assert.IsTrue(e is ArgumentOutOfRangeException);
        ...
        public void FindFirstWhere() {
            var coll1 = EnumerableFromArray(new int[] { 4, 8, 1, 3, 4, 9 });

            var result = Algorithms.FindFirstWhere(coll1, x => (x & 1) == 1);
            Assert.AreEqual(1, result);

            result = Algorithms.FindFirstWhere(coll1, x => (x & 1) == 0);
            Assert.AreEqual(4, result);

            result = Algorithms.FindFirstWhere(coll1, x => x > 10);
            Assert.AreEqual(0, result);

            var coll2 = EnumerableFromArray(new int[] { });
            result = Algorithms.FindFirstWhere(coll2, x => (x & 1) == 1);
            Assert.AreEqual(0, result);
        }
        ...
        public void TryFindFirstWhere() {
            ...
            bool found = Algorithms.TryFindFirstWhere(coll1, x => (x & 1) == 1, out result);
            Assert.IsTrue(found);
            Assert.AreEqual(1, result);

            found = Algorithms.TryFindFirstWhere(coll1, x => (x & 1) == 0, out result);
            Assert.IsTrue(found);
            Assert.AreEqual(4, result);

            found = Algorithms.TryFindFirstWhere(coll1, x => x > 10, out result);
            Assert.IsFalse(found);
            Assert.AreEqual(0, result);

            var coll2 = EnumerableFromArray(new int[] { });
            found = Algorithms.TryFindFirstWhere(coll2, x => (x & 1) == 1, out result);
            Assert.IsFalse(found);
            Assert.AreEqual(0, result);
        }
        ...
        public void FirstOneOf2() {
            ...
            index = Algorithms.FirstIndexOfMany(coll1, EnumerableFromArray(new int[] { 6, 11 }),
                                                delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(0, index);

            index = Algorithms.FirstIndexOfMany(coll1, EnumerableFromArray(new int[] { 3, 8, 9 }),
                                                delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(2, index);
            ...
            index = Algorithms.FirstIndexOfMany(coll1, EnumerableFromArray(new int[] { 10 }),
                                                delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(1, index);
            ...
            index = Algorithms.FirstIndexOfMany(coll1, EnumerableFromArray(new int[] { 13, 5, 0 }),
                                                delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(-1, index);
        ...
        public void LastOneOf2() {
            ...
            index = Algorithms.LastIndexOfMany(coll1, EnumerableFromArray(new int[] { 6, 11 }),
                                               delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(5, index);

            index = Algorithms.LastIndexOfMany(coll1, EnumerableFromArray(new int[] { 3, 8, 9 }),
                                               delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(3, index);

            index = Algorithms.LastIndexOfMany(coll1, EnumerableFromArray(new int[] { 3, 17, 1, 6 }),
                                               delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(4, index);

            index = Algorithms.LastIndexOfMany(coll1, EnumerableFromArray(new int[] { 10 }),
                                               delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(1, index);

            index = Algorithms.LastIndexOfMany(coll1, EnumerableFromArray(new int[] { 3, 7, 9 }),
                                               delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(5, index);

            index = Algorithms.LastIndexOfMany(coll1, EnumerableFromArray(new int[] { 13, 5, 0 }),
                                               delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            Assert.AreEqual(-1, index);
        ...
        public void AllOneOf2() {
            ...
            result = Algorithms.IndicesOfMany(coll1, EnumerableFromArray(new int[] { 6, 11 }),
                                              delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            InterfaceTests.TestEnumerableElements(result, new int[] { 0, 1, 4, 5 });

            result = Algorithms.IndicesOfMany(coll1, EnumerableFromArray(new int[] { 3, 8, 9 }),
                                              delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            InterfaceTests.TestEnumerableElements(result, new int[] { 2, 3 });

            result = Algorithms.IndicesOfMany(coll1, EnumerableFromArray(new int[] { 3, 17, 1, 6 }),
                                              delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            InterfaceTests.TestEnumerableElements(result, new int[] { 0, 1, 2, 3, 4 });

            result = Algorithms.IndicesOfMany(coll1, EnumerableFromArray(new int[] { 10 }),
                                              delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            InterfaceTests.TestEnumerableElements(result, new int[] { 1 });

            result = Algorithms.IndicesOfMany(coll1, EnumerableFromArray(new int[] { 3, 7, 9 }),
                                              delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            InterfaceTests.TestEnumerableElements(result, new int[] { 2, 3, 5 });

            result = Algorithms.IndicesOfMany(coll1, EnumerableFromArray(new int[] { 13, 5, 0 }),
                                              delegate(int x, int y) { return Math.Abs(x - y) == 2; });
            InterfaceTests.TestEnumerableElements(result, new int[] { });
        ...
        public void SearchForSubsequence() {
            ...
            index = Algorithms.SearchForSubsequence(list3, EnumerableFromArray(new string[] { "fat", "big", "bad", "Fiddle" }),
                                                    delegate(string x, string y) { return x[0] == y[0]; });
            Assert.AreEqual(4, index);
        ...
        public void Sort() {
            ...
            IEnumerable<string> enum4 =
                EnumerableFromArray<string>(new string[] { "foo", "A", "l", "missy", "Fiddle", "diddle", "xxx", "YYY" });
        ...
        public void MergeSorted() {
            ...
            int[] a1 = new int[rand.Next(1000)],
                  a2 = new int[rand.Next(1000)],
                  a3 = new int[rand.Next(1000)],
                  a4 = new int[rand.Next(1000)];
            ...
            IEnumerable<string> mergeStr = Algorithms.MergeSorted<string>(delegate(string x, string y) {
                                                                              if(x[0] < y[0])
                                                                                  return -1;
                                                                              else if(x[0] > y[0])
                                                                                  return 1;
                                                                          ...
                                                                          str1, str2, str3);
            InterfaceTests.TestEnumerableElements(mergeStr,
                                                  new string[]
                                                  {
                                                      "foo", "fiddle", "fast", "finagle", "g1", "gross", "g3", "gimpy", "horse", "hippo",
                                                      "igloo", "rascal", "splurge"
                                                  });
        }
        ...
        public void BinarySearch2() {
            IList<String> list =
                new List<String>(new String[] { "foo", "Giraffe", "gorge", "HELLO", "hello", "number", "NUMber", "ooze" });
            int length, index;
        ...
        public void StableSortInPlace() {
            ...
            for(int iter = 0; iter < ITER; ++iter) {
                ...
                Algorithms.StableSortInPlace<KeyWithOrder<int>>(array,
                                                                Algorithms.GetReverseComparer(Comparer<KeyWithOrder<int>>.Default));
