...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public class OrderedSetTests {
        ...
        private class UncomparableClass2 {
            public int Value = 0;
        }
        ...
        public void RemoveAll() {
            ...
            InterfaceTests.TestReadWriteCollectionGeneric(set1, new double[] { -7.6, -0.04, 1.2, 1.78, 4.5, 7.6, 10.11, 187.4 }, true,
                                                          null);
        ...
        public void Clone() {
            ...
            set2 = set1.Clone();
            set3 = set1.Clone(); //(OrderedSet<int>)((ICloneable)set1).Clone();
        ...
        public void CloneContents() {
            ...
            OrderedSet<UtilFixture.CloneableStruct> set5 = new OrderedSet<UtilFixture.CloneableStruct>(comparison);
            ...
            OrderedSet<UtilFixture.CloneableStruct> set6 = set5.CloneContents();

            Assert.AreEqual(set5.Count, set6.Count);

            // Check that the sets are equal, but not identical (e.g., have been cloned via ICloneable).
            IEnumerator<UtilFixture.CloneableStruct> e1 = set5.GetEnumerator();
            IEnumerator<UtilFixture.CloneableStruct> e2 = set6.GetEnumerator();
        ...
        public void SerializeStrings() {
            ...
            InterfaceTests.TestReadWriteCollectionGeneric<string>((ICollection<string>)result,
                                                                  new string[]
                                                                  {
                                                                      null, "1", "10", "11", "12", "2", "3", "4", "5", "6", "7", "8", "9",
                                                                      "cool", "elvis", "foo", "hello", "world"
                                                                  }, true,
