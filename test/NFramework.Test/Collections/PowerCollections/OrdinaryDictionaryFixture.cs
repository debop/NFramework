...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public class OrderedDictionaryTests {
        ...
        public void Add() {
            ...
            try {
                dict1.Add(double.NegativeInfinity, 421);
                Assert.Fail("Exception should be thrown");
            }
            catch(Exception e) {
                CheckArgumentException(e);
            ...
            InterfaceTests.TestReadonlyCollectionGeneric(dict1.Keys,
                                                         new double[]
                                                         {
                                                             double.NaN, double.NegativeInfinity, 4.67, double.MaxValue,
    ...
    /// </summary>
		...
		public void AddOrUpdate()
		{
			...
			TestTool.TestReadonlyCollectionGeneric(dict1.Keys, new double[] { double.NaN, double.NegativeInfinity, 4.67, double.MaxValue, double.PositiveInfinity }, true, "KeysCollection");
			TestTool.TestReadonlyCollectionGeneric(dict1.Values, new int[] { -17, 421, 222, 444, 0 }, true, "ValuesCollection");
		}
#endif
        ...
        public void Update() {
            ...
            try {
                dict1.Replace(double.NegativeInfinity, 187);
                Assert.Fail("Exception should be thrown");
            }
            catch(Exception e) {
        ...
        public void Remove() {
            ...
            InterfaceTests.TestReadonlyCollectionGeneric(dict1.Keys,
                                                         new double[]
                                                         { double.NegativeInfinity, double.MaxValue, double.PositiveInfinity }, true,
                                                         "KeysCollection");
        ...
        public void TryGetValue() {
            ...
            b = dict1.TryGetValue(4.67, out val);
            Assert.IsTrue(b);
            Assert.AreEqual(val, 222);
            b = dict1.TryGetValue(double.NegativeInfinity, out val);
            Assert.IsTrue(b);
            Assert.AreEqual(val, 421);
        }
        ...
        public void KeysValuesCollections() {
            ...
            InterfaceTests.TestReadonlyCollectionGeneric<string>(keysGenCollection, new string[] { "a", "m", "q", "r", "x", "z" }, true,
                                                                 "KeysCollection");
            InterfaceTests.TestCollection<int>(valuesCollection, new int[] { 143, 17, 17, -5, 12, 0 }, true);
            InterfaceTests.TestReadonlyCollectionGeneric<int>(valuesGenCollection, new int[] { 143, 17, 17, -5, 12, 0 }, true,
                                                              "ValuesCollection");
        }
        ...
        public void NullKeysValues() {
            ...
            InterfaceTests.TestReadonlyCollectionGeneric<string>(valuesGenCollection, new string[] { "goodbye", "hello", null }, true,
                                                                 "ValuesCollection");
        ...
        private void CheckEnumeration<TKey, TValue>(IEnumerable<KeyValuePair<TKey, TValue>> inorder,
                                                    IEnumerable<KeyValuePair<TKey, TValue>> reversed,
        ...
        public void Clone() {
            ...
            dict2 = dict1.Clone();
            dict3 = dict1.Clone(); //(OrderedDictionary<string, int>)((ICloneable)dict1).Clone();
            ...
            CheckEnumeration(dict2, dict2.Reversed(), new string[] { "", "a", "b", "foo", "hello", "p", "q", "r4", "ww" },
                             new int[] { 981, 11, 7, 23, 198, 1234, 199, 9, -9 });
            Assert.AreEqual(981, dict2[""]);

            CheckEnumeration(dict3, dict3.Reversed(), new string[] { "", "a", "b", "foo", "hello", "p", "q", "r4", "ww" },
                             new int[] { 981, 11, 7, 23, 198, 1234, 199, 9, -9 });
        ...
        public void CloneContents() {
            ...
            OrderedDictionary<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct> dict5 =
                new OrderedDictionary<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct>(comparison);
            dict5[new UtilFixture.CloneableStruct(7)] = new UtilFixture.CloneableStruct(144);
            dict5[new UtilFixture.CloneableStruct(16)] = new UtilFixture.CloneableStruct(13);
            dict5[new UtilFixture.CloneableStruct(-6)] = new UtilFixture.CloneableStruct(-14);
            dict5[new UtilFixture.CloneableStruct(0)] = new UtilFixture.CloneableStruct(31415);
            dict5[new UtilFixture.CloneableStruct(1111)] = new UtilFixture.CloneableStruct(0);
            OrderedDictionary<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct> dict6 = dict5.CloneContents();

            IEnumerator<KeyValuePair<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct>> e1 = dict5.GetEnumerator();
            IEnumerator<KeyValuePair<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct>> e2 = dict6.GetEnumerator();
        ...
        public void CustomIComparer() {
            ...
            InterfaceTests.TestReadonlyCollectionGeneric<string>(dict1.Values, new string[] { "foo", "baz", "bar", "biff" }, true,
                                                                 "ValuesCollection");
        }
        ...
        public void CloneCustomOrdering() {
            ...
            InterfaceTests.TestReadWriteDictionaryGeneric<int, string>(dict2, new int[] { 3, 9, 8, 12 },
                                                                       new string[] { "foo", "baz", "bar", "biff" }, 7, true, null, null,
                                                                       null);
            InterfaceTests.TestReadWriteDictionaryGeneric<int, string>(dict3, new int[] { 3, 9, 8, 12 },
                                                                       new string[] { "foo", "baz", "bar", "biff" }, 7, true, null, null,
                                                                       null);
        }
#endif
        ...
        public void IDictionaryInterface() {
            ...
            InterfaceTests.TestReadWriteDictionary<string, int>(dict1, s_array_sorted, i_array_sorted, "foo", true,
                                                                "ReadOnlyTestDictionary");
            InterfaceTests.TestReadWriteDictionaryGeneric<string, int>(dict1, s_array_sorted, i_array_sorted, "foo", true,
                                                                       "ReadOnlyTestDictionary", null, null);
        }
        ...
        public void ConstructionWithInitialization() {
            ...
            InterfaceTests.TestDictionaryGeneric<string, int>(dict1,
                                                              new string[]
                                                              { "bar", "fiddle", "foo", "FOO", "goofy", "GOOfy", "trackstar" },
                                                              new int[] { 99, 107, 16, 19, 11, 110, 19 },
                                                              "zippy", true, null, null);

            OrderedDictionary<string, int> dict2 = new OrderedDictionary<string, int>(dict1,
                                                                                      Algorithms.GetReverseComparer(
            ...
            Comparison<string> myComparison = delegate(string x, string y) { return x[0].CompareTo(y[0]); };

            OrderedDictionary<string, int> dict3 = new OrderedDictionary<string, int>(dict1,
                                                                                      Algorithms.GetReverseComparison(myComparison));
