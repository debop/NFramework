...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public class CollectionBaseTests {
        ...
        public void CheckDictionaryKeyValues() {
            ...
            InterfaceTests.TestReadonlyCollectionGeneric<string>(dict.Keys,
                                                                 new string[] { "Eric", "Clapton", "Rules", "The", "Universe" }, false,
                                                                 null);
        ...
        [Test]
        public void Exists() {
            ReadWriteTestCollection<double> coll1 =
                new ReadWriteTestCollection<double>(new double[] { 4.5, 1.2, 7.6, -7.6, -0.04, 1.78, 10.11, 187.4 });
            ...
            ReadOnlyTestCollection<double> coll2 =
                new ReadOnlyTestCollection<double>(new double[] { 4.5, 1.2, 7.6, -7.6, -0.04, 1.78, 10.11, 187.4 });
        ...
        public void FindAll() {
            ReadWriteTestCollection<double> coll1 =
                new ReadWriteTestCollection<double>(new double[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
            ...
            ReadOnlyTestCollection<double> coll2 =
                new ReadOnlyTestCollection<double>(new double[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 });
        ...
        public void RemoveAll() {
            ...
            InterfaceTests.TestReadWriteCollectionGeneric(coll1, new double[] { 4.5, 1.2, 7.6, -0.04, -7.6, 1.78, 10.11, 187.4 }, true,
                                                          null);
