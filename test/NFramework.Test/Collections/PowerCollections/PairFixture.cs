...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public class PairFixture {
        ...
        public void UncomparableFirst() {
            var pair1 = new Pair<Unorderable, int>(new Unorderable(), 5);
            var pair2 = new Pair<Unorderable, int>(new Unorderable(), 7);

            Assert.Throws<NotSupportedException>(() => pair1.CompareTo(pair2));
        }

        [Test]
        public void UncomparableSecond() {
            var pair1 = new Pair<int, Unorderable>(3, new Unorderable());
            var pair2 = new Pair<int, Unorderable>(3, new Unorderable());
            Assert.Throws<NotSupportedException>(() => pair1.CompareTo(pair2));
        }

        [Test]
        public void EqualUncomparable() {
            var pair1 = new Pair<Unorderable, string>(new Unorderable(), "hello");
            var pair2 = new Pair<Unorderable, string>(new Unorderable(), "world");
            var pair3 = new Pair<Unorderable, string>(new Unorderable(), "hello");
        ...
        public void NongenericComparable() {
            var pair1 = new Pair<int, OddEvenComparable>(4, new OddEvenComparable(7));
            var pair2 = new Pair<int, OddEvenComparable>(7, new OddEvenComparable(3));
        ...
        public void GenericComparable() {
            var pair1 = new Pair<int, GOddEvenComparable>(4, new GOddEvenComparable(7));
            var pair2 = new Pair<int, GOddEvenComparable>(7, new GOddEvenComparable(3));
        ...
        public void DictionaryKey() {
            var dict1 = new OrderedDictionary<Pair<string, int>, string>();
        ...
        public void FromKeyValuePair() {
            var kvp1 = new KeyValuePair<int, string>(-13, "hello");
            var p1 = (Pair<int, string>)kvp1;
            Assert.AreEqual(-13, p1.First);
            Assert.AreEqual("hello", p1.Second);

            var q1 = new Pair<int, string>(kvp1);
            Assert.AreEqual(-13, q1.First);
            Assert.AreEqual("hello", q1.Second);

            var kvp2 = new KeyValuePair<string, object>();
            var p2 = (Pair<string, object>)kvp2;
            Assert.IsNull(p2.First);
            Assert.IsNull(p2.Second);

            var q2 = new Pair<string, object>(kvp2);
            Assert.IsNull(q2.First);
            Assert.IsNull(q2.Second);

            object x = new Hashtable();
            var kvp3 = new KeyValuePair<object, double>(x, 6.7);
            var p3 = (Pair<object, double>)kvp3;
            Assert.AreSame(x, p3.First);
            Assert.AreEqual(6.7, p3.Second);

            var q3 = new Pair<object, double>(kvp3);
