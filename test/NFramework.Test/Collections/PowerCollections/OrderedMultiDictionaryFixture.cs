...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public class OrderedMultiDictionaryTests {
        ...
        internal static void CheckOrderedMultiDictionaryContents<TKey, TValue>(OrderedMultiDictionary<TKey, TValue> dict,
                                                                               TKey[] keys,
                                                                               TValue[][] values,
                                                                               TKey nonKey,
                                                                               TValue nonValue,
            ...
            if(keyEquals == null)
                keyEquals = (x, y) => Equals(x, y);

            if(valueEquals == null)
                valueEquals = (x, y) => Equals(x, y);
            ...
            for(iKey = 0; iKey < keys.Length; ++iKey) {
                ...
                iValue = 0;
                foreach(var val in values[iKey]) {
                    Assert.IsTrue(dict.Contains(keys[iKey], val));
                    ++iValue;
                }

                iValue = 0;
                foreach(var val in dict[keys[iKey]]) {
                    Assert.IsTrue(valueEquals(values[iKey][iValue], val));
                    ++iValue;
                }
            ...
            int a = 0;
            var vals = new TValue[valueCount];
            for(iKey = 0; iKey < keys.Length; ++iKey) {
            ...
            a = 0;
            var pairs = new KeyValuePair<TKey, TValue>[valueCount];
            for(iKey = 0; iKey < keys.Length; ++iKey) {
                for(iValue = 0; iValue < values[iKey].Length; ++iValue) {
            ...
            InterfaceTests.TestReadonlyCollectionGeneric<KeyValuePair<TKey, TValue>>(dict.KeyValuePairs, pairs, true, null,
                                                                                     InterfaceTests.KeyValueEquals<TKey, TValue>(
            ...
            InterfaceTests.TestReadWriteMultiDictionaryGeneric<TKey, TValue>(dict, keys, values, nonKey, nonValue, true,
                                                                             "OrderedMultiDictionary", keyEquals, valueEquals);
        }
        ...
        private int[,] AddRemoveRandom(Random rand, OrderedMultiDictionary<int, string> dict, bool useDups, int iter) {
            ...
            var counts = new int[MAXKEY,MAXVAL];

            for(int x = 0; x < iter; ++x) {
                var key = rand.Next(MAXKEY);
                var val = rand.Next(MAXVAL);
                var valString = string.Format("A{0:0000}", val);
        ...
        public void Add() {
            ...
            CheckOrderedMultiDictionaryContents<string, double>(dict1,
                                                                ...
                                                                new double[][]
                                                                {
                                                                    new double[] { 5.5, 11.1 }, new double[] { 9.8 },
                                                                    new double[] { -1.2, 3.5, 8.8 }, new double[] { 7.1 },
                                                                    new double[] { -9 }
                                                                },
                                                                "zip", -100, null, null);
            ...
            CheckOrderedMultiDictionaryContents<string, double>(dict1,
                                                                ...
                                                                new double[][]
                                                                {
                                                                    new double[] { 5.5, 11.1, 11.1 }, new double[] { 9.8 },
                                                                    new double[] { -1.2, 3.5, 8.8, 8.8 }, new double[] { 7.1 },
                                                                    new double[] { -9 }
                                                                },
                                                                "zip", -100, null, null);

            // Test duplicate values with distinct equal values.
            var dict2 = new OrderedMultiDictionary<string, string>(false, StringComparer.InvariantCultureIgnoreCase,
            ...
            dict2 = new OrderedMultiDictionary<string, string>(true, StringComparer.InvariantCultureIgnoreCase,
                                                               StringComparer.InvariantCultureIgnoreCase);
            dict2.Add("foo", "BAR");
            dict2.Add("Foo", "bar");
            InterfaceTests.TestEnumerableElements<string>(dict2.Keys, new string[] { "foo" });
            ...
            InterfaceTests.TestEnumerableElements<KeyValuePair<string, string>>
                (dict2.KeyValuePairs, new KeyValuePair<string, string>[]
                                      {
                                          new KeyValuePair<string, string>("foo", "BAR"),
                                          new KeyValuePair<string, string>("Foo", "bar")
                                      }, InterfaceTests.KeyValueEquals<string, string>());
        }
        ...
        public void Replace() {
            ...
            CheckOrderedMultiDictionaryContents(dict1,
                                                ...
                                                new int[][]
                                                { new int[] { 7, 8 }, new int[] { 123, 123 }, new int[] { 193 }, new int[] { 19 } },
        ...
        public void ReplaceMany() {
            ...
            CheckOrderedMultiDictionaryContents(dict1,
                                                ...
                                                new int[][]
                                                {
                                                    new int[] { 7, 8 }, new int[] { 0, 4, 29, 123 }, new int[] { -11, 193 },
                                                    new int[] { 19 }
                                                },
                                                "sailor", 19921, null, null);
        }
        ...
        public void ValuesCollection1() {
            OrderedMultiDictionary<double, string> dict = new OrderedMultiDictionary<double, string>(false, Comparer<double>.Default,
                                                                                                     StringComparer.
                                                                                                         InvariantCultureIgnoreCase);
        ...
        public void ValuesCollection2() {
            OrderedMultiDictionary<double, string> dict = new OrderedMultiDictionary<double, string>(true, Comparer<double>.Default,
                                                                                                     StringComparer.
                                                                                                         InvariantCultureIgnoreCase);
        ...
        public void KeyValuesCollection1() {
            OrderedMultiDictionary<string, string> dict = new OrderedMultiDictionary<string, string>(false,
                                                                                                     StringComparer.
                                                                                                         InvariantCultureIgnoreCase,
                                                                                                     StringComparer.
                                                                                                         InvariantCultureIgnoreCase);
        ...
        public void KeyValuesCollection2() {
            OrderedMultiDictionary<string, string> dict = new OrderedMultiDictionary<string, string>(true,
                                                                                                     StringComparer.
                                                                                                         InvariantCultureIgnoreCase,
                                                                                                     StringComparer.
                                                                                                         InvariantCultureIgnoreCase);
        ...
        public void GetValueCount() {
            ...
            dict1 = new OrderedMultiDictionary<string, string>(false, StringComparer.InvariantCultureIgnoreCase,
                                                               StringComparer.InvariantCultureIgnoreCase);
        ...
        public void IMultiDictionaryInterface() {
            ...
            CheckOrderedMultiDictionaryContents<string, string>(dict1,
                                                                ...
                                                                {
                                                                    new string[] { "hello", "hi" },
                                                                    new string[] { "a", "a", "bar", "bar" },
                                                                    new string[] { null, null, "sailor" }, new string[] { "mix" }
                                                                },
            ...
            CheckOrderedMultiDictionaryContents<string, string>(dict1,
                                                                ...
                                                                new string[][]
                                                                {
                                                                    new string[] { "hello", "hi" }, new string[] { "a", "bar" },
                                                                    new string[] { null, "sailor" }, new string[] { "mix" }
                                                                },
                                                                "zippy", "pinhead", null, null);
        }
        ...
        public void CustomComparison() {
            ...
            OrderedMultiDictionary<string, string> dict2 = new OrderedMultiDictionary<string, string>(false,
                                                                                                      StringComparer.
                                                                                                          InvariantCultureIgnoreCase.
                                                                                                          Compare, reverseFirstLetter);
        ...
        public void NotComparable1() {
            OrderedMultiDictionary<OrderedDictionaryTests.UncomparableClass1, string> dict1 =
                new OrderedMultiDictionary<OrderedDictionaryTests.UncomparableClass1, string>(false);
        }

        [Test, ExpectedException(typeof(InvalidOperationException))]
        public void NotComparable2() {
            OrderedMultiDictionary<string, OrderedDictionaryTests.UncomparableClass2> dict2 =
        ...
        public void Clone() {
            ...
            OrderedMultiDictionary<string, string> dict1 = new OrderedMultiDictionary<string, string>(false,
                                                                                                      StringComparer.
                                                                                                          InvariantCultureIgnoreCase.
                                                                                                          Compare, reverseFirstLetter);
            ...
            dict2 = dict1.Clone(); // ((OrderedMultiDictionary<string, string>)((ICloneable)dict1).Clone());
        ...
        public void CloneContents() {
            Comparison<OrderedDictionaryTests.MyInt> myIntComparison =
                delegate(OrderedDictionaryTests.MyInt v1, OrderedDictionaryTests.MyInt v2) {
                    if(v1 == null)
                        return (v2 == null) ? 0 : -1;
                    else if(v2 == null)
                        return 1;
            ...
            OrderedMultiDictionary<int, OrderedDictionaryTests.MyInt> dict1 =
                new OrderedMultiDictionary<int, OrderedDictionaryTests.MyInt>(true,
                                                                              delegate(int v1, int v2) { return -v2.CompareTo(v1); },
                                                                              myIntComparison);

            dict1.Add(4, new OrderedDictionaryTests.MyInt(143));
            dict1.Add(7, new OrderedDictionaryTests.MyInt(2));
            dict1.Add(11, new OrderedDictionaryTests.MyInt(9));
            dict1.Add(7, new OrderedDictionaryTests.MyInt(119));
            dict1.Add(18, null);
            dict1.Add(4, new OrderedDictionaryTests.MyInt(16));
            dict1.Add(7, null);
            dict1.Add(7, new OrderedDictionaryTests.MyInt(119));
            OrderedMultiDictionary<int, OrderedDictionaryTests.MyInt> dict2 = dict1.CloneContents();
            CompareClones(dict1, dict2);

            OrderedMultiDictionary<OrderedDictionaryTests.MyInt, int> dict3 =
                new OrderedMultiDictionary<OrderedDictionaryTests.MyInt, int>(false, myIntComparison);

            dict3.Add(new OrderedDictionaryTests.MyInt(4), 143);
            dict3.Add(new OrderedDictionaryTests.MyInt(7), 2);
            dict3.Add(new OrderedDictionaryTests.MyInt(11), 9);
            dict3.Add(new OrderedDictionaryTests.MyInt(7), 119);
            dict3.Add(new OrderedDictionaryTests.MyInt(18), 0);
            dict3.Add(new OrderedDictionaryTests.MyInt(4), 16);
            dict3.Add(null, 11);
            dict3.Add(new OrderedDictionaryTests.MyInt(7), 119);

            OrderedMultiDictionary<OrderedDictionaryTests.MyInt, int> dict4 = dict3.CloneContents();
            CompareClones(dict3, dict4);

            Comparison<UtilFixture.CloneableStruct> comparison =
                delegate(UtilFixture.CloneableStruct s1, UtilFixture.CloneableStruct s2) { return s1.value.CompareTo(s2.value); };
            OrderedMultiDictionary<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct> dict5 =
                new OrderedMultiDictionary<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct>(true, comparison, comparison);
            dict5.Add(new UtilFixture.CloneableStruct(7), new UtilFixture.CloneableStruct(-14));
            dict5.Add(new UtilFixture.CloneableStruct(16), new UtilFixture.CloneableStruct(13));
            dict5.Add(new UtilFixture.CloneableStruct(7), new UtilFixture.CloneableStruct(-14));
            dict5.Add(new UtilFixture.CloneableStruct(7), new UtilFixture.CloneableStruct(31415));
            dict5.Add(new UtilFixture.CloneableStruct(1111), new UtilFixture.CloneableStruct(0));
            OrderedMultiDictionary<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct> dict6 = dict5.CloneContents();

            IEnumerator<KeyValuePair<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct>> e1 = dict5.KeyValuePairs.GetEnumerator();
            IEnumerator<KeyValuePair<UtilFixture.CloneableStruct, UtilFixture.CloneableStruct>> e2 = dict6.KeyValuePairs.GetEnumerator();
        ...
        public void KeyComparerProperty() {
            ...
            OrderedMultiDictionary<string, string> dict3 = new OrderedMultiDictionary<string, string>(true,
            ...
            OrderedMultiDictionary<int, string> dict5 = new OrderedMultiDictionary<int, string>(false, comparison1,
                                                                                                delegate(string x, string y) { return -x.CompareTo(y); });
        ...
        public void ValueComparerProperty() {
            IComparer<int> comparer1 = new GOddEvenComparer();
            OrderedMultiDictionary<string, int> dict1 = new OrderedMultiDictionary<string, int>(true, StringComparer.InvariantCulture,
                                                                                                comparer1);
            ...
            Comparison<int> comparison1 = ComparersTests.CompareOddEven;
            OrderedMultiDictionary<string, int> dict4 = new OrderedMultiDictionary<string, int>(true,
                                                                                                delegate(string x, string y) { return x.CompareTo(y); }, comparison1);
            OrderedMultiDictionary<string, int> dict5 = new OrderedMultiDictionary<string, int>(false,
                                                                                                delegate(string x, string y) { return -x.CompareTo(y); }, comparison1);
        ...
        // Check the contents of a Multi-Dictionary non-destructively. Keys and Values must be in order.
        internal static void CheckView<TKey, TValue>(OrderedMultiDictionary<TKey, TValue>.View dict, TKey[] keys, TValue[][] values,
                                                     TKey nonKey, TValue nonValue, bool cantAddNonKey, Func<TKey, TKey, bool> keyEquals,
                                                     Func<TValue, TValue, bool> valueEquals) {
            int iKey, iValue;
            ICollection<TValue> getValues;
            ...
            // Test IDictionary<TKey,IEnumerable<TValue>> implementation
            InterfaceTests.TestReadWriteMultiDictionaryGeneric<TKey, TValue>(dict, keys, values, nonKey, nonValue, true,
                                                                             "OrderedMultiDictionary", null, null);
        }
        ...
        public void RangeFrom() {
            ...
            CheckView<string, double>(dict1.RangeFrom("bar", true),
                                      ...
                                      new double[][]
                                      {
                                          new double[] { 9.8 }, new double[] { -1.2, 3.5, 8.8 }, new double[] { 1.1, 7.1 },
                                          new double[] { -9 }
                                      },
            ...
            CheckView<string, double>(dict1.RangeFrom("bar", true).Reversed(),
                                      ...
                                      new double[][]
                                      {
                                          new double[] { -9 }, new double[] { 1.1, 7.1 }, new double[] { -1.2, 3.5, 8.8 },
                                          new double[] { 9.8 }
                                      },
        ...
        public void RangeTo() {
            ...
            CheckView<string, double>(dict1.RangeTo("gib", true),
                                      ...
                                      new double[][]
                                      {
                                          new double[] { 5.5, 11.1 }, new double[] { 9.8 }, new double[] { -1.2, 3.5, 8.8 },
                                          new double[] { 1.1, 7.1 }
                                      },
                                      "S", -9, true, null, null);
            ...
            CheckView<string, double>(dict1.RangeTo("Z", false),
                                      ...
                                      {
                                          new double[] { 5.5, 11.1 }, new double[] { 9.8 }, new double[] { -1.2, 3.5, 8.8 },
                                          new double[] { 1.1, 7.1 }, new double[] { -9 }
                                      },
            ...
            CheckView<string, double>(dict1.RangeTo("gib", true).Reversed(),
                                      ...
                                      new double[][]
                                      {
                                          new double[] { 1.1, 7.1 }, new double[] { -1.2, 3.5, 8.8 }, new double[] { 9.8 },
                                          new double[] { 5.5, 11.1 }
                                      },
                                      "S", -9, true, null, null);
            ...
            CheckView<string, double>(dict1.RangeTo("gib", false).Reversed(),
                                      ...
                                      new double[][]
                                      { new double[] { -1.2, 3.5, 8.8 }, new double[] { 9.8 }, new double[] { 5.5, 11.1 } },
                                      "gib", 1.1, true, null, null);
        }
        ...
        public void Range() {
            ...
            CheckView<string, double>(dict1.Range(null, true, "S", true).Reversed(),
                                      ...
                                      {
                                          new double[] { -9 }, new double[] { 1.1, 7.1 }, new double[] { -1.2, 3.5, 8.8 },
                                          new double[] { 9.8 }, new double[] { 5.5, 11.1 }
                                      },
                                      "Speedo", -14, true, null, null);
        ...
        public void RangeClear() {
            ...
            CheckOrderedMultiDictionaryContents<string, double>(dict2,
                                                                ...
                                                                new double[][]
                                                                {
                                                                    new double[] { 5.5, 11.1 }, new double[] { 9.8 }, new double[] { -9 }
                                                                },
                                                                "foo", 3.5, null, null);
            ...
            CheckOrderedMultiDictionaryContents<string, double>(dict2,
                                                                ...
                                                                {
                                                                    new double[] { 5.5, 11.1 }, new double[] { 9.8 },
                                                                    new double[] { -1.2, 3.5, 8.8 }, new double[] { 1.1, 7.1 }
                                                                },
                                                                "S", 3.7, null, null);
        ...
        public void SerializeStrings() {
            OrderedMultiDictionary<string, double> d = new OrderedMultiDictionary<string, double>(true,
                                                                                                  StringComparer.
                                                                                                      InvariantCultureIgnoreCase);
            ...
            CheckOrderedMultiDictionaryContents<String, double>(result,
                                                                ...
                                                                new double[][]
                                                                {
                                                                    new double[] { 1.4 }, new double[] { 0.9, 1.4 }, new double[] { 7, 7 }
                                                                    , new double[] { 11, 12, 13 }, new double[] { -9.5 }
                                                                },
