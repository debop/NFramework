...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    internal static class InterfaceTests {
        public static Func<KeyValuePair<TKey, TValue>, KeyValuePair<TKey, TValue>, bool> KeyValueEquals<TKey, TValue>(
            Func<TKey, TKey, bool> keyEquals, Func<TValue, TValue, bool> valueEquals) {
            if(keyEquals == null)
            ...
            return
                delegate(KeyValuePair<TKey, TValue> pair1, KeyValuePair<TKey, TValue> pair2) { return keyEquals(pair1.Key, pair2.Key) && valueEquals(pair1.Value, pair2.Value); };
        }
        ...
        public static Func<ICollection<T>, ICollection<T>, bool> CollectionEquals<T>(Func<T, T, bool> equals, bool inOrder) {
            if(inOrder) {
        ...
        public static void TestEnumerableElements<T>(IEnumerable<T> e, T[] expected, Func<T, T, bool> equals) {
            if(equals == null)
        ...
        public static void TestEnumerableElementsAnyOrder<T>(IEnumerable<T> e, T[] expected, Func<T, T, bool> equals) {
            if(equals == null)
                equals = delegate(T x, T y) { return object.Equals(x, y); };
        ...
        public static void TestCollection<T>(ICollection coll, T[] valueArray, bool mustBeInOrder) {
            ...
            if(coll.Count > 0) {
                ...
                try {
                    ...
                    Assert.IsTrue(e is ArgumentOutOfRangeException || e is InvalidOperationException);
                }
            }
        }
        ...
        private static void TestCollectionGeneric<T>(ICollection<T> coll, T[] values, bool mustBeInOrder, Func<T, T, bool> equals) {
            if(equals == null)
                equals = delegate(T x, T y) { return object.Equals(x, y); };
            ...
            if(coll.Count != 0) {
                ...
                try {
                    ...
                    Assert.IsTrue(e is ArgumentNullException || e is InvalidOperationException, "Exception is " + e.GetType().Name);
                }
                try {
                    coll.CopyTo(newKeys, 3);
                    Assert.Fail("CopyTo should throw argument exception");
                    ...
                    Assert.IsTrue(e is ArgumentException || e is InvalidOperationException, "Exception is " + e.GetType().Name);
                }
                try {
                    coll.CopyTo(newKeys, -1);
                    Assert.Fail("CopyTo should throw argument out of range exception");
                    ...
                    Assert.IsTrue(e is ArgumentOutOfRangeException || e is InvalidOperationException, "Exception is " + e.GetType().Name);
                }
            }
        }
        ...
        private static void CheckReadonlyCollectionException(Exception e, string name) {
            Assert.IsTrue((e is NotSupportedException) || (e is InvalidOperationException));
        ...
        public static void TestReadOnlyDictionary<TKey, TValue>(IDictionary dict, TKey[] keys, TValue[] values, TKey nonKey,
                                                                bool mustBeInOrder, string name) {
        ...
        /// <param name="nonKey">A TKey that isn't in the dictionary</param>
        /// <param name="name">Name of the dictionary, used in exceptions.</param>
        public static void TestReadWriteDictionary<TKey, TValue>(IDictionary dict, TKey[] keys, TValue[] values, TKey nonKey,
                                                                 bool mustBeInOrder, string name) {
            DictionaryEntry[] entries = new DictionaryEntry[keys.Length];
            for(int i = 0; i < keys.Length; ++i)
                entries[i] = new DictionaryEntry(keys[i], values[i]);
        ...
        /// <param name="keyEquals"></param>
        public static void TestDictionaryGeneric<TKey, TValue>(IDictionary<TKey, TValue> dict, TKey[] keys, TValue[] values, TKey nonKey,
                                                               bool mustBeInOrder, Func<TKey, TKey, bool> keyEquals,
        ...
        /// <param name="keyEquals"></param>
        /// <param name="valueEquals"></param>
        public static void TestReadOnlyDictionaryGeneric<TKey, TValue>(IDictionary<TKey, TValue> dict, TKey[] keys, TValue[] values,
                                                                       TKey nonKey, bool mustBeInOrder, string name,
            ...
            TestReadonlyCollectionGeneric<KeyValuePair<TKey, TValue>>((ICollection<KeyValuePair<TKey, TValue>>)dict, entries,
                                                                      mustBeInOrder, name, KeyValueEquals(keyEquals, valueEquals));
        ...
        /// <param name="keyEquals"></param>
        /// <param name="valueEquals"></param>
        public static void TestReadWriteDictionaryGeneric<TKey, TValue>(IDictionary<TKey, TValue> dict, TKey[] keys, TValue[] values,
                                                                        TKey nonKey, bool mustBeInOrder, string name,
                                                                        Func<TKey, TKey, bool> keyEquals,
                                                                        Func<TValue, TValue, bool> valueEquals) {
            if(keyEquals == null)
            ...
            TestDictionaryGeneric<TKey, TValue>(dict, keys, values, nonKey, mustBeInOrder, keyEquals, valueEquals);
            TestCollectionGeneric<KeyValuePair<TKey, TValue>>((ICollection<KeyValuePair<TKey, TValue>>)dict, entries, mustBeInOrder,
                                                              KeyValueEquals(keyEquals, valueEquals));
        ...
        public static void TestListGeneric<T>(IList<T> coll, T[] valueArray, Func<T, T, bool> equals) {
            if(equals == null)
                equals = delegate(T x, T y) { return object.Equals(x, y); };
        ...
        public static void TestReadWriteListGeneric<T>(IList<T> coll, T[] valueArray, Func<T, T, bool> equals) {
            if(equals == null)
                equals = delegate(T x, T y) { return object.Equals(x, y); };
        ...
        public static void TestReadOnlyListGeneric<T>(IList<T> coll, T[] valueArray, string name, Func<T, T, bool> equals) {
            if(equals == null)
                equals = delegate(T x, T y) { return object.Equals(x, y); };
        ...
        public static void TestReadWriteMultiDictionaryGeneric<TKey, TValue>(IDictionary<TKey, ICollection<TValue>> dict, TKey[] keys,
                                                                             TValue[][] values, TKey nonKey, TValue nonValue,
                                                                             bool mustBeInOrder, string name,
                                                                             Func<TKey, TKey, bool> keyEquals,
                                                                             Func<TValue, TValue, bool> valueEquals) {
            if(keyEquals == null)
            ...
            if(valueEquals == null)
                valueEquals = delegate(TValue x, TValue y) { return object.Equals(x, y); };
            var valueCollectionEquals = CollectionEquals(valueEquals, mustBeInOrder);

            TestReadWriteDictionaryGeneric<TKey, ICollection<TValue>>(dict, keys, values, nonKey, mustBeInOrder, name, keyEquals,
                                                                      valueCollectionEquals);
        }

        public static void TestReadOnlyMultiDictionaryGeneric<TKey, TValue>(IDictionary<TKey, ICollection<TValue>> dict, TKey[] keys,
                                                                            TValue[][] values, TKey nonKey, TValue nonValue,
                                                                            bool mustBeInOrder, string name,
                                                                            Func<TKey, TKey, bool> keyEquals,
                                                                            Func<TValue, TValue, bool> valueEquals) {
            ...
            TestReadOnlyDictionaryGeneric<TKey, ICollection<TValue>>(dict, keys, values, nonKey, mustBeInOrder, name, keyEquals,
                                                                     valueCollectionEquals);
        }

        public static void TestMultiDictionaryGeneric<TKey, TValue>(IDictionary<TKey, ICollection<TValue>> dict, TKey[] keys,
                                                                    TValue[][] values, TKey nonKey, TValue nonValue, bool mustBeInOrder,
                                                                    Func<TKey, TKey, bool> keyEquals,
                                                                    Func<TValue, TValue, bool> valueEquals) {
            if(keyEquals == null)
                keyEquals = (x, y) => Equals(x, y); //delegate(TKey x, TKey y) { return object.Equals(x, y); };
            if(valueEquals == null)
                valueEquals = (x, y) => Equals(x, y); // delegate(TValue x, TValue y) { return object.Equals(x, y); };
        ...
        public class Unique {
            ...
            public static bool EqualValues(Unique x, Unique y) {
                if(x == null || y == null)
                    return x == y;
                else
