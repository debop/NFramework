...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public class DequeTests {
        ...
        public void GenericIListInterface() {
            ...
            InterfaceTests.TestReadWriteListGeneric<string>((IList<string>)d,
                                                            new string[] { "cool", "elvis", "hello", "foo", "world", "elvis", null });
        }
        ...
        public void Insert() {
            ...
            d.Insert(4, "m");
            d.Insert(2, "n");
            InterfaceTests.TestEnumerableElements(d,
                                                  new string[] { "i", "c", "n", "j", "l", "m", "e", "k", "h", "a", "g", "d", "f", "b" });
        ...
        public void SerializeUnique() {
            ...
            d.deque.AddManyToFront(new InterfaceTests.Unique[]
                                   { d.objects[0], d.objects[1], d.objects[2], d.objects[3], d.objects[4], d.objects[5] });
            d.deque.AddManyToBack(new InterfaceTests.Unique[]
