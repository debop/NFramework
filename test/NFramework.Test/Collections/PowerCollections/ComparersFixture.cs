...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    /// </summary>
    internal class OddEvenComparable : System.IComparable {
        public int val;
    ...
    /// Comparable that compares ints, sorting odds before evens.
    /// </summary>
    internal class GOddEvenComparable : System.IComparable<GOddEvenComparable> {
        public int val;
    ...
    /// </summary>
    internal class OddEvenComparer : System.Collections.IComparer {
    ...
    /// Comparer that compares ints, sorting odds before evens.
    /// </summary>
    internal class GOddEvenEqualityComparer : System.Collections.Generic.IEqualityComparer<int> {
    ...
    public class ComparersTests {
        ...
        public static bool FirstCharEqual(string s1, string s2) {
            if(s1 == null || s2 == null || s1.Length == 0 || s2.Length == 0) {
                if(s1.IsNotWhiteSpace())
                    return false;
                if(s2.IsNotWhiteSpace())
                    return false;
        ...
        public void ComparerKeyValueFromComparerKey() {
            IComparer<KeyValuePair<int, string>> comparer =
                Comparers.ComparerKeyValueFromComparerKey<int, string>(new GOddEvenComparer());
        ...
        public void EqualityComparerKeyValueFromComparerKey() {
            IEqualityComparer<KeyValuePair<int, string>> comparer =
                Comparers.EqualityComparerKeyValueFromComparerKey<int, string>(new GOddEvenEqualityComparer());
        ...
        public void ComparerPairFromKeyValueComparers() {
            IComparer<KeyValuePair<int, string>> comparer =
                Comparers.ComparerPairFromKeyValueComparers<int, string>(new GOddEvenComparer(),
        ...
        public void DefaultKeyValueComparerNonGeneric() {
            ...
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(7), 12),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(6), 19)) < 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(7), 133),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(8), 1)) < 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(12), 34),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(11), 3)) > 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(12), 8),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(143), 6)) > 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(5), 1),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(7), 0)) < 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(9), 3),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(5), 23)) > 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(6), 5),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(8), 4)) < 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(14), 1),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(-8), 0)) > 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(0), 4),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(0), 17)) == 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(-3), 2),
                                 new KeyValuePair<OddEvenComparable, short>(new OddEvenComparable(-3), 1)) == 0);
        }
        ...
        public void DefaultKeyValueComparerGeneric() {
            ...
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(7), 12),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(6), 19)) < 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(7), 133),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(8), 1)) < 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(12), 34),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(11), 3)) > 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(12), 8),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(143), 6)) > 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(5), 1),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(7), 0)) < 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(9), 3),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(5), 23)) > 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(6), 5),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(8), 4)) < 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(14), 1),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(-8), 0)) > 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(0), 4),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(0), 17)) == 0);
            Assert.IsTrue(
                comparer.Compare(new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(-3), 2),
                                 new KeyValuePair<GOddEvenComparable, short>(new GOddEvenComparable(-3), 1)) == 0);
        }
