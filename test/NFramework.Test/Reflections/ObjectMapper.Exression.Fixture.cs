...
namespace NSoft.NFramework.Reflections {
    ...
    /// </summary>
    [TestFixture]
    public class ObjectMapper_Expression_Fixture : AbstractFixture {
        ...
        public void ObjectMap() {
            using(new OperationTimer("Object Map")) {
                foreach(var source in SourceDatas) {
                    var target = ObjectMapper.MapProperty<TargetData>(source, () => new TargetData(), t => t.OtherDataOnly);
        ...
        public void ObjectMapReverse() {
            using(new OperationTimer("Object Map Reverse")) {
                foreach(var target in TargetDatas) {
                    var source = ObjectMapper.MapProperty<SourceData>(target, () => new SourceData(), s => s.DataOnly);
        ...
        public void ObjectMapProperty() {
            using(new OperationTimer("Object MapProperty")) {
                SourceDatas
                    ...
                    .AsOrdered()
                    .Run(source => {
                             var target = source.MapProperty(() => new TargetData(), t => t.OtherDataOnly);
        ...
        public void ObjectMapPropertyReverse() {
            using(new OperationTimer("Object MapProperty Reverse")) {
                TargetDatas
                    ...
                    .AsOrdered()
                    .Run((target) => {
                             var source = target.MapProperty(() => new SourceData(), s => s.DataOnly);
        ...
        public void ObjectMapProperty_ReturnTarget() {
            using(new OperationTimer("Object MapProperty<T>")) {
                foreach(var source in SourceDatas) {
                    var target = ObjectMapper.MapProperty<TargetData>(source, () => new TargetData(100), t => t.OtherDataOnly);
