...
using NSoft.NFramework.Data.MongoDB.NHCaches.Domains.Models;
...
namespace NSoft.NFramework.Data.MongoDB.NHCaches.Domains {
    ...
    /// </summary>
    public abstract class MongoRepositoryTestFixtureBase : MongoDatabaseTestFixtureBase {
        #region << logger >>
        ...
        protected static NHibernate.Criterion.Order[] OrderByNameAndAgeDescending {
            get {
                return new[]
                       {
                           NHibernate.Criterion.Order.Desc("Name"),
                           NHibernate.Criterion.Order.Desc("Age")
                       };
            }
        }
