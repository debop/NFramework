...
namespace NSoft.NFramework.Data.NHibernateEx.Domain.Mappings {
    ...
    public class User : DataEntityBase<int>, IUser {
        public User() {}
        ...
        public override int GetHashCode() {
            ...
            return HashTool.Compute(Name, RegisteredAt);
        }
    }

    public enum EnumStoredAsString {
        Unspecified,
        Small,
        Medium,
        Large
    ...
    public class EnumStoredAsStringType : EnumStringType {
        ...
        public override object Get(IDataReader rs, int index) {
            ...
            if(obj == null)
                return EnumStoredAsString.Unspecified;
            return obj;
        }
    }
}