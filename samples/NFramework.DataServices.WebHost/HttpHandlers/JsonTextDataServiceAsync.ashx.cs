...
namespace NSoft.NFramework.DataServices.WebHost.HttpHandlers {
    /// <summary>
    /// JsonTextDataService 는 Javascript, jQuery 등에서 JSON 포맷으로 요청을 보낼 때 처리하고, JSON 포맷 TEXT 로 반환하는 비동기 방식 Handler 입니다.
    /// </summary>
    /// <example>
    /// <code>
    ...
    /// </code>
    /// </example>
    public class JsonTextDataServiceAsync : DataServiceAsync {
        #region << logger >>
