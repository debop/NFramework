...
namespace NSoft.NFramework.Data {
    ...
    /// </summary>
    [Serializable]
    public abstract class AbstractNamedParameter : ValueObjectBase, INamedParameter {
        /// <summary>
        ///Initialize a new instance of NamedParameterBase with parameter name and value
        /// </summary>
        /// <param name="name">parameter name</param>
        /// <param name="value">parameter value</param>
        protected AbstractNamedParameter(string name, object value = null) {
        ...
        public override string ToString() {
            return string.Format("AbstractNamedParameter# Name=[{0}], Value=[{1}]", Name, Value);
        }
    }
}