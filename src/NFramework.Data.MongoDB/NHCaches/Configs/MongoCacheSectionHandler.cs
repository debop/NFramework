...
namespace NSoft.NFramework.Data.MongoDB.NHCaches {
    ...
    /// </code>
    /// </example>
    public class MongoCacheSectionHandler : IConfigurationSectionHandler {
        #region << logger >>
        ...
        public object Create(object parent, object configContext, XmlNode section) {
            ...
            var cacheConfigs = new List<MongoCacheConfig>();
            ...
            foreach(XmlElement node in nodes) {
                ...
                cacheConfigs.Add(new MongoCacheConfig(region, connectionString, expiration, compressThreshold));
            }
