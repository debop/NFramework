...
namespace NSoft.NFramework.Configurations {
    /// <summary>
    /// Represents a named <see cref="System.Configuration.ConfigurationElement"/> wher the name is the key to a collection.
    /// </summary>
    /// <remarks>
    /// This class is used in conjunction with a <see cref="NSoft.NFramework.Configurations.NamedElementCollection{T}"/>.
    /// </remarks>
