...
using System;
using NSoft.NFramework.Compressions.SevenZip.Compression.RangeCoder;

namespace NSoft.NFramework.Compressions.SevenZip.Compression.LZMA {
    internal class LzmaEncoder : ICoder, ISetCoderProperties, IWriteCoderProperties {
        ...
        private LzmaBase.State _state = new LzmaBase.State();
        private Byte _previousByte;
        private UInt32[] _repDistances = new UInt32[LzmaBase.kNumRepDistances];
        ...
        private class LenEncoder {
            ...
            private RangeCoder.BitTreeEncoder[] _lowCoder = new RangeCoder.BitTreeEncoder[LzmaBase.kNumPosStatesEncodingMax];
            private RangeCoder.BitTreeEncoder[] _midCoder = new RangeCoder.BitTreeEncoder[LzmaBase.kNumPosStatesEncodingMax];
            private RangeCoder.BitTreeEncoder _highCoder = new RangeCoder.BitTreeEncoder(LzmaBase.kNumHighLenBits);
        ...
        private class LenPriceTableEncoder : LenEncoder {
            private UInt32[] _prices = new UInt32[LzmaBase.kNumLenSymbols << LzmaBase.kNumPosStatesBitsEncodingMax];
            private UInt32 _tableSize;
            private UInt32[] _counters = new UInt32[LzmaBase.kNumPosStatesEncodingMax];
        ...
        private RangeCoder.BitEncoder[] _isMatch = new RangeCoder.BitEncoder[LzmaBase.kNumStates << LzmaBase.kNumPosStatesBitsMax];
        private RangeCoder.BitEncoder[] _isRep = new RangeCoder.BitEncoder[LzmaBase.kNumStates];
        private RangeCoder.BitEncoder[] _isRepG0 = new RangeCoder.BitEncoder[LzmaBase.kNumStates];
        private RangeCoder.BitEncoder[] _isRepG1 = new RangeCoder.BitEncoder[LzmaBase.kNumStates];
        private RangeCoder.BitEncoder[] _isRepG2 = new RangeCoder.BitEncoder[LzmaBase.kNumStates];
        private RangeCoder.BitEncoder[] _isRep0Long = new RangeCoder.BitEncoder[LzmaBase.kNumStates << LzmaBase.kNumPosStatesBitsMax];

        private RangeCoder.BitTreeEncoder[] _posSlotEncoder = new RangeCoder.BitTreeEncoder[LzmaBase.kNumLenToPosStates];

        private RangeCoder.BitEncoder[] _posEncoders =
            new RangeCoder.BitEncoder[LzmaBase.kNumFullDistances - LzmaBase.kEndPosModelIndex];

        private RangeCoder.BitTreeEncoder _posAlignEncoder = new RangeCoder.BitTreeEncoder(LzmaBase.kNumAlignBits);
        ...
        private UInt32[] _matchDistances = new UInt32[LzmaBase.kMatchMaxLen * 2 + 2];
        ...
        private UInt32[] _posSlotPrices = new UInt32[1 << (LzmaBase.kNumPosSlotBits + LzmaBase.kNumLenToPosStatesBits)];
        private UInt32[] _distancesPrices = new UInt32[LzmaBase.kNumFullDistances << LzmaBase.kNumLenToPosStatesBits];
        private UInt32[] _alignPrices = new UInt32[LzmaBase.kAlignTableSize];
        ...
        private UInt32[] reps = new UInt32[LzmaBase.kNumRepDistances];
        private UInt32[] repLens = new UInt32[LzmaBase.kNumRepDistances];
        ...
        private UInt32 GetOptimum(UInt32 position, out UInt32 backRes) {
            ...
            _optimum[1].Price = _isMatch[(_state.Index << LzmaBase.kNumPosStatesBitsMax) + posState].GetPrice0() +
                                _literalEncoder.GetSubCoder(position, _previousByte).GetPrice(!_state.IsCharState(), matchByte,
                                                                                              currentByte);
        ...
        private UInt32[] tempPrices = new UInt32[LzmaBase.kNumFullDistances];
