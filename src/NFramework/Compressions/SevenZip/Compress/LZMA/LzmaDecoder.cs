...
namespace NSoft.NFramework.Compressions.SevenZip.Compression.LZMA {
    internal class LzmaDecoder : ICoder, ISetDecoderProperties // ,System.IO.Stream
    {
        ...
        private BitDecoder[] m_IsMatchDecoders = new BitDecoder[LzmaBase.kNumStates << LzmaBase.kNumPosStatesBitsMax];
        private BitDecoder[] m_IsRepDecoders = new BitDecoder[LzmaBase.kNumStates];
        private BitDecoder[] m_IsRepG0Decoders = new BitDecoder[LzmaBase.kNumStates];
        private BitDecoder[] m_IsRepG1Decoders = new BitDecoder[LzmaBase.kNumStates];
        private BitDecoder[] m_IsRepG2Decoders = new BitDecoder[LzmaBase.kNumStates];
        private BitDecoder[] m_IsRep0LongDecoders = new BitDecoder[LzmaBase.kNumStates << LzmaBase.kNumPosStatesBitsMax];

        private BitTreeDecoder[] m_PosSlotDecoder = new BitTreeDecoder[LzmaBase.kNumLenToPosStates];
        private BitDecoder[] m_PosDecoders = new BitDecoder[LzmaBase.kNumFullDistances - LzmaBase.kEndPosModelIndex];
