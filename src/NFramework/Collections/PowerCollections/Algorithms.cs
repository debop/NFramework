...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    internal delegate bool BinaryFunc<T>(T item1, T item2);
    ...
    public static class Algorithms {
        ...
        private class ListRange<T> : ListBase<T>, ICollection<T> {
            ...
            public override bool Remove(T item) {
                if(_wrappedList.IsReadOnly)
                    throw new InvalidOperationException(string.Format(Strings.CannotModifyCollection, "Range"));
        ...
        /// Methods that modify the collection throw a InvalidOperationException, methods that don't
        ...
        private class ReadOnlyCollection<T> : ICollection<T> {
            ...
            public ReadOnlyCollection(ICollection<T> wrappedCollection) {
                wrappedCollection.ShouldNotBeNull("wrappedCollection");
                _wrappedCollection = wrappedCollection;
            }

            /// <summary>
            /// Throws an InvalidOperationException stating that this collection cannot be modified.
            /// </summary>
            private static void MethodModifiesCollection() {
                throw new InvalidOperationException(string.Format(Strings.CannotModifyCollection, "read-only collection"));
            }
        ...
        /// Methods that modify the list throw a InvalidOperationException, methods that don't
        ...
        private class ReadOnlyList<T> : IList<T> {
            ...
            public ReadOnlyList(IList<T> wrappedList) {
                wrappedList.ShouldNotBeNull("wrappedList");
                _wrappedList = wrappedList;
            }
            ...
            /// </summary>
            private static void MethodModifiesCollection() {
                throw new InvalidOperationException(string.Format(Strings.CannotModifyCollection, "read-only list"));
            }
        ...
        private class ReadOnlyDictionary<TKey, TValue> : IDictionary<TKey, TValue> {
            ...
            public ReadOnlyDictionary(IDictionary<TKey, TValue> wrappedDictionary) {
                wrappedDictionary.ShouldNotBeNull("wrappedDictionary");
            ...
            /// </summary>
            private static void MethodModifiesCollection() {
                throw new InvalidOperationException(string.Format(Strings.CannotModifyCollection, "read-only dictionary"));
            }
        ...
        private class TypedEnumerator<T> : IEnumerator<T> {
            ...
            public TypedEnumerator(IEnumerator wrappedEnumerator) {
                wrappedEnumerator.ShouldNotBeNull("wrappedEnumerator");
        ...
        private class TypedEnumerable<T> : IEnumerable<T> {
            ...
            public TypedEnumerable(IEnumerable wrappedEnumerable) {
                wrappedEnumerable.ShouldNotBeNull("wrappedEnumerable");
        ...
        private class TypedCollection<T> : ICollection<T> {
            ...
            /// </summary>
            private static void MethodModifiesCollection() {
                throw new InvalidOperationException(string.Format(Strings.CannotModifyCollection, "strongly-typed Collection"));
            }
        ...
        private class ArrayWrapper<T> : ListBase<T>, IList {
            ...
            public ArrayWrapper(T[] wrappedArray) {
                wrappedArray.ShouldNotBeNull("wrappedArray");
                _wrappedArray = wrappedArray;
            }
        ...
        public static IEnumerable<T> Replace<T>(IEnumerable<T> collection, T itemFind, T replaceWith,
            ...
            return collection.Select(item => equalityComparer.Equals(item, itemFind) ? replaceWith : item);
        }
        ...
        public static IEnumerable<T> Replace<T>(IEnumerable<T> collection, Func<T, bool> predicate, T replaceWith) {
            ...
            return collection.Select(item => predicate(item) ? replaceWith : item);
        }
        ...
        /// <returns>An new collection with the items from <paramref name="collection"/>, in the same order, 
        /// with consecutive "duplicates" removed.</returns>
        public static IEnumerable<T> RemoveDuplicates<T>(IEnumerable<T> collection, Func<T, T, bool> predicate) {
            collection.ShouldNotBeNull("collection");
            predicate.ShouldNotBeNull("predicate");
            ...
            foreach(T item in collection) {
                ...
                if(atBeginning || predicate(current, item) == false) {
                    current = item;
                    yield return item;
                }
        ...
        public static void RemoveDuplicatesInPlace<T>(IList<T> list, Func<T, T, bool> predicate) {
            list.ShouldNotBeNull("list");
            predicate.ShouldNotBeNull("predicate");
            ...
            while(j < listCount) {
                T item = list[j];
                if(i < 0 || predicate(current, item) == false) {
                    current = item;
                    ++i;
                    if(i != j)
                        list[i] = current;
        ...
        /// <param name="predicate">The BinaryPredicate used to compare items for "equality". </param>
        /// <returns>The index of the first item in the first run of <paramref name="count"/> consecutive equal items, or -1 if no such run exists.</returns>
        public static int FirstConsecutiveEqual<T>(IList<T> list, int count, Func<T, T, bool> predicate) {
            if(list == null)
        ...
        public static T FindLastWhere<T>(IEnumerable<T> collection, Func<T, bool> predicate) {
            ...
            return TryFindLastWhere(collection, predicate, out retval) ? retval : default(T);
        }
        ...
        public static int FirstIndexOfMany<T>(IList<T> list, IEnumerable<T> itemsToLookFor, IEqualityComparer<T> equalityComparer) {
            list.ShouldNotBeNull("list");
            itemsToLookFor.ShouldNotBeNull("itemsToLookFor");
            equalityComparer.ShouldNotBeNull("equalityComparer");
        ...
        /// -1 if no such item exists in the list.</returns>
        public static int FirstIndexOfMany<T>(IList<T> list, IEnumerable<T> itemsToLookFor, Func<T, T, bool> predicate) {
            list.ShouldNotBeNull("list");
            itemsToLookFor.ShouldNotBeNull("itemsToLookFor");
            predicate.ShouldNotBeNull("predicate");
            ...
            foreach(var x in list) {
                T x1 = x;
                if(itemsToLookFor.Any(y => predicate(x1, y))) {
                    return index;
                }
        ...
        /// <paramref name="predicate"/> as the test for equality. 
        /// -1 if no such item exists in the list.</returns>
        public static int LastIndexOfMany<T>(IList<T> list, IEnumerable<T> itemsToLookFor, Func<T, T, bool> predicate) {
            list.ShouldNotBeNull("list");
            itemsToLookFor.ShouldNotBeNull("itemsToLookFor");
            predicate.ShouldNotBeNull("predicate");
            ...
            for(int index = list.Count - 1; index >= 0; --index) {
                var index1 = index;
                if(itemsToLookFor.Any(y => predicate(list[index1], y))) {
                    return index;
                }
            }
        ...
        public static IEnumerable<int> IndicesOfMany<T>(IList<T> list, IEnumerable<T> itemsToLookFor, Func<T, T, bool> predicate) {
            list.ShouldNotBeNull("list");
            itemsToLookFor.ShouldNotBeNull("itemsToLookFor");
            predicate.ShouldNotBeNull("predicate");
        ...
        /// <param name="predicate">The BinaryPredicate used to compare items for "equality". </param>
        /// <returns>The first index with <paramref name="list"/> that matches the items in <paramref name="pattern"/>.</returns>
        public static int SearchForSubsequence<T>(IList<T> list, IEnumerable<T> pattern, Func<T, T, bool> predicate) {
            list.ShouldNotBeNull("list");
            ...
            for(int start = 0; start <= listCount - patternCount; ++start) {
                for(int count = 0; count < patternCount; ++count) {
                    if(predicate(list[start + count], patternArray[count]) == false)
                        goto NOMATCH;
                }
        ...
        public static bool IsSubsetOf<T>(IEnumerable<T> collection1, IEnumerable<T> collection2, IEqualityComparer<T> equalityComparer) {
            collection1.ShouldNotBeNull("collection1");
            collection2.ShouldNotBeNull("collection2");
            equalityComparer.ShouldNotBeNull("equalityComparer");
        ...
        public static bool DisjointSets<T>(IEnumerable<T> collection1, IEnumerable<T> collection2, IEqualityComparer<T> equalityComparer) {
            ...
            return collection2.All(item => set1.Contains(item) == false);
        }
...
#if !SILVERLIGHT
        private static volatile Random myRandomGenerator = ThreadTool.CreateRandom();
#else
        ...
        private static Random GetRandomGenerator() {
            if(myRandomGenerator == null) {
                lock(typeof(Algorithms)) {
                    if(myRandomGenerator == null)
#if !SILVERLIGHT
                        myRandomGenerator = ThreadTool.CreateRandom();
#else
        ...
        public static T[] RandomShuffle<T>(IEnumerable<T> collection, Random randomGenerator) {
            ...
            collection.ShouldNotBeNull("collection");
            randomGenerator.ShouldNotBeNull("randomGenerator");
        ...
        public static T[] RandomSubset<T>(IEnumerable<T> collection, int count, Random randomGenerator) {
            ...
            for(var i = 0; i < count; ++i) {
                ...
                result[i] = value;
                if(i != j) {
                    swappedValues[j] = swappedValues.TryGetValue(i, out value) ? value : list[i];
                }
            }
        ...
        public static T Maximum<T>(IEnumerable<T> collection, IComparer<T> comparer) {
            ...
            foreach(T item in collection) {
                if(foundOne == false || comparer.Compare(maxSoFar, item) < 0) {
                    maxSoFar = item;
                }
        ...
        public static T Minimum<T>(IEnumerable<T> collection, IComparer<T> comparer) {
            ...
            foreach(T item in collection) {
                if(foundOne == false || comparer.Compare(minSoFar, item) > 0) {
                    minSoFar = item;
                }
        ...
        public static int IndexOfMinimum<T>(IList<T> list, Comparison<T> comparison) {
            return IndexOfMinimum(list, Comparers.ComparerFromComparison<T>(comparison));
        }
        ...
        public static void SortInPlace<T>(IList<T> list, IComparer<T> comparer) {
            ...
            var leftStack = new int[32];
            var rightStack = new int[32];
            var stackPtr = 0;
        ...
        public static void SortInPlace<T>(IList<T> list, Comparison<T> comparison) {
            SortInPlace(list, Comparers.ComparerFromComparison<T>(comparison));
        }
        ...
        public static T[] StableSort<T>(IEnumerable<T> collection, IComparer<T> comparer) {
            ...
            StableSortInPlace<T>(ReadWriteList<T>(array), comparer);
            return array;
        }
        ...
        public static Comparison<T> GetReverseComparison<T>(Comparison<T> comparison) {
            comparison.ShouldNotBeNull("comparision");
        ...
        private class CollectionEqualityComparer<T> : IEqualityComparer<IEnumerable<T>> {
            ...
            public bool Equals(IEnumerable<T> x, IEnumerable<T> y) {
                return EqualCollections<T>(x, y, _equalityComparer);
            }
            ...
            public int GetHashCode(IEnumerable<T> obj) {
                ...
                //foreach(T t in obj)
                //{
                //	var itemHash = Util.GetHashCode(t, _equalityComparer);
                //	hash += itemHash;
                //	hash = (hash << 9) | (hash >> 23);
                //}
        ...
        private class SetEqualityComparer<T> : IEqualityComparer<IEnumerable<T>> {
            ...
            public bool Equals(IEnumerable<T> x, IEnumerable<T> y) {
                return EqualSets<T>(x, y, _equalityComparer);
            }
        ...
        /// <seealso cref="EqualSets{T}(System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEnumerable{T})"/>
        ...
        public static IEnumerable<TDest> Convert<TSource, TDest>(IEnumerable<TSource> sourceCollection, Func<TSource, TDest> converter) {
            sourceCollection.ShouldNotBeNull("sourceCollection");
            converter.ShouldNotBeNull("converter");

            return sourceCollection.Select(sourceItem => converter(sourceItem));
        }
        ...
        public static Func<TKey, TValue> GetDictionaryConverter<TKey, TValue>(IDictionary<TKey, TValue> dictionary, TValue defaultValue) {
            dictionary.ShouldNotBeNull("dictionary");
        ...
        public static IEnumerable<T> Concatenate<T>(params IEnumerable<T>[] collections) {
            collections.ShouldNotBeNull("collections");
        ...
        public static bool EqualCollections<T>(IEnumerable<T> collection1, IEnumerable<T> collection2, Func<T, T, bool> predicate) {
            collection1.ShouldNotBeNull("collection1");
            collection2.ShouldNotBeNull("collection2");
            predicate.ShouldNotBeNull("predicate");
