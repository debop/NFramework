namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public static class Strings {
        ...
        public static readonly string WrongType =
            "The value \"{0}\" isn't of type \"{1}\" and can't be used in this generic collection.";

        public static readonly string MustOverrideOrReimplement =
            "This method must be overridden or re-implemented in the derived class.";
        ...
        public static readonly string InconsistentComparisons =
