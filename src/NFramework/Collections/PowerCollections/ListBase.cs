...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public abstract class ListBase<T> : CollectionBase<T>, IList<T>, IList {
        ...
        public virtual int FindIndex(int index, Func<T, bool> predicate) {
            var foundIndex = Algorithms.FindFirstIndexWhere<T>(Range(index, Count - index), predicate);
        ...
        public virtual int FindIndex(int index, int count, Func<T, bool> predicate) {
            var foundIndex = Algorithms.FindFirstIndexWhere<T>(Range(index, count), predicate);
        ...
        public virtual int FindLastIndex(int index, int count, Func<T, bool> predicate) {
            var foundIndex = Algorithms.FindLastIndexWhere<T>(Range(index - count + 1, count), predicate);
        ...
        public virtual int IndexOf(T item, int index) {
            var foundIndex = Algorithms.FirstIndexOf<T>(Range(index, Count - index), item, EqualityComparer<T>.Default);
        ...
        public virtual int IndexOf(T item, int index, int count) {
            var foundIndex = Algorithms.FirstIndexOf<T>(Range(index, count), item, EqualityComparer<T>.Default);
        ...
        public virtual int LastIndexOf(T item, int index) {
            return Algorithms.LastIndexOf<T>(Range(0, index + 1), item, EqualityComparer<T>.Default);
        }
        ...
        public virtual int LastIndexOf(T item, int index, int count) {
            var foundIndex = Algorithms.LastIndexOf<T>(Range(index - count + 1, count), item, EqualityComparer<T>.Default);
