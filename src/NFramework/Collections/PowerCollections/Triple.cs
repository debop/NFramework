...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    public struct Triple<TFirst, TSecond, TThird> : IComparable, IComparable<Triple<TFirst, TSecond, TThird>> {
        ...
        private static readonly IComparer<TThird> _thirdComparer = Comparer<TThird>.Default;
        ...
        private static readonly IEqualityComparer<TThird> _thirdEqualityComparer = EqualityComparer<TThird>.Default;
        ...
        public override bool Equals(object obj) {
            return obj != null && obj is Triple<TFirst, TSecond, TThird> && Equals((Triple<TFirst, TSecond, TThird>)obj);
        }
        ...
        public bool Equals(Triple<TFirst, TSecond, TThird> other) {
            return _firstEqualityComparer.Equals(First, other.First) &&
                   ...
                   _thirdEqualityComparer.Equals(Third, other.Third);
        }
        ...
        public int CompareTo(Triple<TFirst, TSecond, TThird> other) {
            try {
                ...
                var secondCompare = _secondComparer.Compare(Second, other.Second);

                return secondCompare != 0 ? secondCompare : _thirdComparer.Compare(Third, other.Third);
            }
                ...
                if(!typeof(IComparable<TThird>).IsAssignableFrom(typeof(TThird)) &&
        ...
        public override string ToString() {
            return string.Format("First=[{0}], Second=[{1}], Third=[{2}]",
                                 First.AsText("null"), Second.AsText("null"), Third.AsText("null"));
        }
