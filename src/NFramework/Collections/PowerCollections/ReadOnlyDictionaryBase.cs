    ...
    public abstract class ReadOnlyDictionaryBase<TKey, TValue> : ReadOnlyCollectionBase<KeyValuePair<TKey, TValue>>,
        ...
        public override string ToString() {
            ...
            foreach(KeyValuePair<TKey, TValue> pair in this) {
                ...
                builder.Append(pair.Key.AsText("null"));
                builder.Append("->");
                builder.Append(pair.Value.AsText("null"));
        ...
        bool IDictionary.Contains(object key) {
            return (key is TKey || Equals(key, null)) && ContainsKey((TKey)key);
        }
        ...
        object IDictionary.this[object key] {
            get {
                if(key is TKey || Equals(key, null)) {
                    var theKey = (TKey)key;
                    TValue theValue;
                    ...
                    return TryGetValue(theKey, out theValue) ? (object)theValue : null;
                }
                return null;
            }
            set { MethodModifiesCollection(); }
        ...
        private sealed class KeysCollection : ReadOnlyCollectionBase<TKey> {
            ...
            public override IEnumerator<TKey> GetEnumerator() {
                return myDictionary.Select(pair => pair.Key).GetEnumerator();
            }
        ...
        private sealed class ValuesCollection : ReadOnlyCollectionBase<TValue> {
            private readonly ReadOnlyDictionaryBase<TKey, TValue> _myDictionary;
            ...
            public override IEnumerator<TValue> GetEnumerator() {
                return _myDictionary.Select(pair => pair.Value).GetEnumerator();
            }
        }
        ...
        private class DictionaryEnumeratorWrapper : IDictionaryEnumerator {
            ...
            public DictionaryEntry Entry {
                get {
                    ...
                    if(ReferenceEquals(pair.Key, null) == false)
                        entry.Key = pair.Key;
