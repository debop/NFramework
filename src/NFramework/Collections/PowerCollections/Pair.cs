...
namespace NSoft.NFramework.Collections.PowerCollections {
    ...
    /// </summary>
    [Serializable]
    public struct Pair<TFirst, TSecond> : IComparable, IComparable<Pair<TFirst, TSecond>>, IEquatable<Pair<TFirst, TSecond>> {
        /// <summary>
        /// Comparers for the first type that are used to compare values.
        /// </summary>
        private static readonly IComparer<TFirst> _firstComparer = Comparer<TFirst>.Default;

        /// <summary>
        /// Comparers for the second type that are used to compare values.
        /// </summary>
        ...
        public override bool Equals(object obj) {
            return (obj != null) && (obj is Pair<TFirst, TSecond>) && Equals((Pair<TFirst, TSecond>)obj);
        }
        ...
        public override int GetHashCode() {
            return HashTool.Compute(First, Second);
        }
        ...
        public int CompareTo(Pair<TFirst, TSecond> other) {
            try {
                ...
                return firstCompare != 0
                           ? firstCompare
                           : _secondComparer.Compare(Second, other.Second);
            }
        ...
        public override string ToString() {
            return string.Format("First: {0}, Second: {1}", First.AsText("null"), Second.AsText("null"));
        }
