...
namespace NSoft.NFramework.Tools {
    ...
    /// </summary>
    public static class MimetypeTool {
        #region << logger >>
        ...
        public const string Mimetype_Default = @"application/octet-stream";
        public const string Mimetype_Javascript = @"application/javascript";

        /// <summary>
        /// fileExtension - Mimetype 을 쌍으로 가지는 캐시 정보입니다.
        /// </summary>
        private static readonly Dictionary<string, string> _mimetypeCache
        ...
        public static string GetMime(this string filename) {
            ...
            mimeType = mimeType ?? Mimetype_Default;
