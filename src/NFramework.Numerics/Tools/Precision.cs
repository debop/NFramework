...
namespace NSoft.NFramework.Numerics {
    ...
    public static class Precision {
        ...
        ///     Thrown if <paramref name="maxNumbersBetween"/> is smaller than zero.
        /// </exception>
        public static void RangeOfMatchingFloatingPointNumbers(this double value, long maxNumbersBetween, out double bottomRangeEnd,
                                                               out double topRangeEnd) {
        ...
        /// <returns>true if the two values differ by no more than 10 * 2^(-52); false otherwise.</returns>
        public static bool AlmostEqual<T>(this T a, T b) where T : IPrecisionSupport<T> {
            double diff = a.NormOfDifference(b);
            return AlmostEqualWithError(a.Norm(), b.Norm(), diff, _defaultDoubleRelativeAccuracy);
        }
        ...
        /// </returns>
        public static bool AlmostEqualWithError<T>(this T a, T b, double maximumError) where T : IPrecisionSupport<T> {
        ...
        /// maximum error, <see langword="false" /> otherwise.
        /// </returns>
        public static bool AlmostEqualListWithError<T>(this IList<T> a, IList<T> b, double maximumError) where T : IPrecisionSupport<T> {
            if(a == null && b == null) {
                return true;
            }
