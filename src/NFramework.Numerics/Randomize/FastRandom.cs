...
namespace NSoft.NFramework.Numerics {
    ...
    public sealed class FastRandom {
        ...
        private uint x;
        private uint y = 842502087, z = 3579807591, w = 273326509;
        ...
        public void Reinitialize(int seed) {
            ...
            // the seeds x,y,z,w is non-zero. We fullfil that requirement by only allowing
