...
namespace RCL.Web.Pages
{
    ...
    public abstract class EntityGridControlBase<T> : DefaultControlBase, IEntityGridPage<T> where T : class
    {
        #region << logger >>
        ...
        protected static readonly GridItemType[] GridItemTypeForEditing = new GridItemType[]
                                                                          {
                                                                              GridItemType.Item,
        ...
        {
            get { return ViewState["PageIndex"].AsInt(); }
        ...
        /// Loading 시 기본출력여부
        /// </summary>
        public virtual bool IsDisplayDefault
        {
            get { return ViewState["IsDisplayDefault"].AsBool(true); }
            set { ViewState["IsDisplayDefault"] = value; }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if((IsPostBack == false) && IsDisplayDefault)
                DisplayDefault();
        }
        ...
        {
            if(IsDebugEnabled)
                log.Debug(@"목록 페이지가 변경됩니다... pageIndex=" + pageIndex);
