...
namespace NSoft.NFramework.Data.MySql.EnterpriseLibrary {
    ...
    /// 	<providerMappings>
    /// 		<add databaseType="NSoft.NFramework.Data.MySql.EnterpriseLibrary.MySqlProvider, NSoft.NFramework.Data.MySql" name="MySql.Data.MySqlClient" />
    /// 	</providerMappings>
    /// </dataConfiguration>
    /// </code>
    /// </example>
    [DatabaseAssembler(typeof(MySqlDatabaseAssembler))]
    [ConfigurationElementType(typeof(MySqlDatabase))]
    public class MySqlDatabase : Database {
        ...
        public MySqlDatabase(string connectionString)
            ...
            if(IsDebugEnabled)
                log.Debug("Microsoft EntLib DAAB 방식의 MySqlProvider 인스턴스를 생성했습니다. connectionString=[{0}]", connectionString);
        }
        ...
        protected DbParameter CreateParameter(string name,
                                              ...
                                              DataRowVersion sourceVersion,
                                              object value) {
            var param = CreateParameter(name) as MySqlParameter;
        ...
        public static MySqlCommand CheckIfMySqlCommand(DbCommand command) {
            ...
            mySqlCommand.ShouldNotBeNull("mySqlCommand");
            return mySqlCommand;
        }
