...
namespace NSoft.NFramework.Data.NHibernateEx.ForTesting {
    ...
    public abstract class DatabaseTestFixtureBase {
        ...
        private const string TestModeKey = @"NSoft.NFramework.Data.NHibernateEx.ForTesting.DatabaseTestFixtureBase.IsRunningInTestMode";
...
#pragma warning disable 1591
        ...
        public class NHibernateInitializer {
            ...
            public static string DeriveDatabaseNameFrom(DatabaseEngine databaseEngine, Assembly assembly) {
                ...
                if(IsDebugEnabled)
                    log.Debug("Drived Database name = [{0}]", dbName);
